...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 6.8 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 6.7" href="release_notes_6_7.html" />
    <link rel="prev" title="Version 6.9" href="release_notes_6_9.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_6_7.html" title="Version 6.7"
             accesskey="N">next</a> |</li>
        <li class="right" >
          <a href="release_notes_6_9.html" title="Version 6.9"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 6.8</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-6-8">
<h1>Version 6.8<a class="headerlink" href="#version-6-8" title="Link to this heading">¶</a></h1>
<p>Release date: 2022-04-07</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin4 6.7.</p>
<section id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Link to this heading">¶</a></h2>
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7215">Issue #7215</a> -  Added transaction start time to Server activity sessions view.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7249">Issue #7249</a> -  Added support for unique keys in ERD.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7257">Issue #7257</a> -  Support running the container under OpenShift with alternate UIDs.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7132">Issue #7132</a> -  Port Properties panel for collection node, Dashboard, and SQL panel in React.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7149">Issue #7149</a> -  Port preferences dialog to React.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4256">Issue #4256</a> -  Fixed an issue where SQL for revoke statements are not shown for databases.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5836">Issue #5836</a> -  Adds a new LDAP authentication configuration parameter that indicates the case sensitivity of the LDAP schema/server.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6960">Issue #6960</a> -  Ensure that the master password dialog is popped up if the crypt key is missing.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7059">Issue #7059</a> -  Fixed an issue where the error is shown on logout when the authentication source is oauth2.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7176">Issue #7176</a> -  Fixed an issue where the browser tree state was not preserved correctly.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7197">Issue #7197</a> -  Fixed an issue where foreign key relationships do not update when the primary key is modified.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7216">Issue #7216</a> -  Ensure that the values of certain fields are prettified in the statistics tab for collection nodes.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7221">Issue #7221</a> -  Ensure objects depending on extensions are not displayed in Schema Diff.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7238">Issue #7238</a> -  Fixed an issue where foreign key is not removed even if the referred table is removed in ERD.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7239">Issue #7239</a> -  Fixed an issue where the newly added table is not visible under the Tables node on refresh.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7261">Issue #7261</a> -  Correct typo in the documentation.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7263">Issue #7263</a> -  Fixed schema diff issue where function’s difference DDL was showing incorrectly when arguments had default values with commas.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7264">Issue #7264</a> -  Ensure that the correct user should be selected in the new connection dialog.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7265">Issue #7265</a> -  Fixed schema diff issue in which the option ‘null’ doesn’t appear in the DDL statement for the foreign table.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7267">Issue #7267</a> -  Fixed an issue where unexpected error messages are displayed when users change the language via preferences.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7269">Issue #7269</a> -  Ensure that pgAdmin4 should work with latest jinja2 version.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7275">Issue #7275</a> -  Fixed ‘Cannot read properties of undefined’ error while creating the table via the ERD tool.</div>
</div>
</div></blockquote>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 6.8</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 6.8</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_6_7.html" title="Version 6.7">next</a> |</li>
            <li class="right" ><a href="release_notes_6_9.html" title="Version 6.9">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
