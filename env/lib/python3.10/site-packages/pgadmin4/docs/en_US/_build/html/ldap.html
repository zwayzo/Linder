...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Enabling LDAP Authentication &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Enabling Kerberos Authentication" href="kerberos.html" />
    <link rel="prev" title="Lock/Restore Account" href="restore_locked_user.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">Enabling LDAP Authentication</a></li> 
      </ul>
    </div>  
...
<tr class="row-odd"><td><p>LDAP_CERT_VALIDATE</p></td>
<td><p>Set this parameter to <em>False</em> if you want to bypass
the TLS certificate validation. By default it is set to True.</p></td>
</tr>
<tr class="row-even"><td><p>LDAP_IGNORE_MALFORMED_SCHEMA</p></td>
<td><p>Some flaky LDAP servers returns malformed schema.
If this parameter set to <em>True</em>, no exception will be raised and schema is thrown away
but authentication will be done. This parameter should remain False, as recommended.</p></td>
</tr>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Enabling LDAP Authentication</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="kerberos.html" title="Enabling Kerberos Authentication">next</a> |</li>
            <li class="right" ><a href="restore_locked_user.html" title="Lock/Restore Account">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
