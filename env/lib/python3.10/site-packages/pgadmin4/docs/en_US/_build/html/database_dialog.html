...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Database Dialog &#8212; pgAdmin 4 9.11 documentation</title>
...
This option is available from v15 and above. <strong>Note:</strong> The icu and libc options are available
from v15 and builtin option is available from v17 onwards.</p></li>
...
<li><p>Select the builtin locale from the drop-down listbox in the <em>Builtin Locale</em> if the
builtin locale provider is used. This option is available from v17 and above.</p></li>
...
<li><p>If <em>Template?</em> is set to <em>Yes</em>, the database will be a template database.</p></li>
</ul>
...
For example, you might enter: <em>public</em> so that only <em>public</em> is shown in
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="resource_group_dialog.html" title="Resource Group Dialog">next</a> |</li>
            <li class="right" ><a href="managing_cluster_objects.html" title="Managing Cluster Objects">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
