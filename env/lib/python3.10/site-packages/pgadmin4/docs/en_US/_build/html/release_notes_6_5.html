...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 6.5 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 6.4" href="release_notes_6_4.html" />
    <link rel="prev" title="Version 6.6" href="release_notes_6_6.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_6_6.html" title="Version 6.6"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 6.5</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-6-5">
<h1>Version 6.5<a class="headerlink" href="#version-6-5" title="Link to this heading">¶</a></h1>
<p>Release date: 2022-02-11</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin4 6.4.</p>
<section id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7139">Issue #7139</a> -  Added support to open SQL help, Dialog help, and online help in an external web browser.</div>
</div>
</section>
<section id="housekeeping">
<h2>Housekeeping<a class="headerlink" href="#housekeeping" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7016">Issue #7016</a> -  Port Dependent, dependencies, statistics panel to React.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7017">Issue #7017</a> -  Port Import/Export dialog to React.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7163">Issue #7163</a> -  Rename the menu ‘Disconnect Server’ to ‘Disconnect from server’.</div>
</div>
</section>
<section id="bug-fixes">
<h2>Bug fixes<a class="headerlink" href="#bug-fixes" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6916">Issue #6916</a> -  Added flag in runtime to disable GPU hardware acceleration.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7035">Issue #7035</a> -  Fixed an issue where connections keep open to (closed) connections on the initial connection to the database server.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7085">Issue #7085</a> -  Ensure that Partitioned tables should be visible correctly when creating multiple partition levels.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7086">Issue #7086</a> -  Correct documentation for ‘Add named restore point’.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7100">Issue #7100</a> -  Fixed an issue where the Browser tree gets disappears when scrolling sequences.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7109">Issue #7109</a> -  Make the size blank for all the directories in the file select dialog.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7110">Issue #7110</a> -  Ensure that cursor should be focused on the first options of the Utility dialogs.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7118">Issue #7118</a> -  Ensure that JSON files should be downloaded properly from the storage manager.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7123">Issue #7123</a> -  Fixed an issue where restore generates incorrect options for the schema.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7126">Issue #7126</a> -  Fixed an issue where the F2 Function key removes browser panel contents.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7127">Issue #7127</a> -  Added validation for Hostname in the server dialog.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7135">Issue #7135</a> -  Enforce the minimum Windows version that the installer will run on.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7136">Issue #7136</a> -  Fixed an issue where the query tool is displaying an incorrect label.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7142">Issue #7142</a> -  Fixed an issue where a warning message was shown after database creation/modification.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7145">Issue #7145</a> -  Ensure that owner should be ignored while comparing extensions.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7146">Issue #7146</a> -  Fixed event trigger comparing issue in Schema Diff tool.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7150">Issue #7150</a> -  Fixed an issue when uploading a CSV throwing an error in the Desktop mode.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7151">Issue #7151</a> -  Fixed value error in the restore dialog.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7154">Issue #7154</a> -  Ensure that the layout should not be reset if a query tool is opened and pgAdmin is restarted.</div>
</div>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 6.5</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 6.5</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_6_4.html" title="Version 6.4">next</a> |</li>
            <li class="right" ><a href="release_notes_6_6.html" title="Version 6.6">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
