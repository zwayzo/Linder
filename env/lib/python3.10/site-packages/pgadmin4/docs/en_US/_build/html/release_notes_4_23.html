...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 4.23 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 4.22" href="release_notes_4_22.html" />
    <link rel="prev" title="Version 4.24" href="release_notes_4_24.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">Version 4.23</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-4-23">
<h1>Version 4.23<a class="headerlink" href="#version-4-23" title="Link to this heading">¶</a></h1>
<p>Release date: 2020-06-25</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin4 4.22.</p>
<section id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5468">Issue #5468</a> -  Added option to ignore the whitespaces while comparing objects in schema diff.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5500">Issue #5500</a> -  Added server group name while selecting servers in schema diff.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5516">Issue #5516</a> -  Added support of Row Security Policies.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5576">Issue #5576</a> -  Improve error messaging if the storage and log directories cannot be created.</div>
</div>
</section>
<section id="housekeeping">
<h2>Housekeeping<a class="headerlink" href="#housekeeping" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5325">Issue #5325</a> -  Improve code coverage and API test cases for Collations.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5574">Issue #5574</a> -  Cleanup Windows build scripts and ensure Windows x64 builds will work.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5581">Issue #5581</a> -  Documentation of Row Level Security Policies.</div>
</div>
</section>
<section id="bug-fixes">
<h2>Bug fixes<a class="headerlink" href="#bug-fixes" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3591">Issue #3591</a> -  Ensure that the query tool should display the proper error message while terminating the active session.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3669">Issue #3669</a> -  Ensure that proper error should be displayed for the deleted node.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3787">Issue #3787</a> -  Disabled the Stop process button after clicking it and added a message ‘Terminating the process…’ to notify the user.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4226">Issue #4226</a> -  Fixed an issue where select all checkbox only selects the first 50 tables.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5416">Issue #5416</a> -  Ensure that the query tool panel gets closed when clicking on the ‘Don’t Save’ button.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5465">Issue #5465</a> -  Fixed an issue where the Edge browser version is showing wrong and warning message gets displayed.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5492">Issue #5492</a> -  Fixed an issue where the search object is unable to locate inherited tables and constraint filters are not working.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5507">Issue #5507</a> -  Fixed connection and version number detection issue when the database server is upgraded.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5521">Issue #5521</a> -  Fixed an issue when dumping servers from a desktop pgAdmin app by providing an option ‘–sqlite-path’.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5539">Issue #5539</a> -  Fixed typo in exception keyword.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5584">Issue #5584</a> -  Fixed an issue where two identical tables showing different by schema diff tool.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5592">Issue #5592</a> -  Ensure that pgadmin should be able to connect to the server which has password more than 1000 characters.</div>
</div>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 4.23</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.23</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_4_22.html" title="Version 4.22">next</a> |</li>
            <li class="right" ><a href="release_notes_4_24.html" title="Version 4.24">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
