...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Materialized View Dialog &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">Materialized View Dialog</a></li> 
      </ul>
    </div>  
  ...
  <section id="materialized-view-dialog">
<span id="id1"></span><h1><span class="target" id="index-0"></span>Materialized View Dialog<a class="headerlink" href="#materialized-view-dialog" title="Link to this heading">¶</a></h1>
...
through the following dialog tabs: <em>General</em>, <em>Definition</em>, <em>Code</em>,
...
<p>Use the fields in the <em>Definition</em> tab to maintain the materialized view:</p>
<ul class="simple">
...
<li><p>Use the drop-down list box next to Access Method to specify the table access method to use to store the contents
...
<li><p>Use the drop-down listbox next to <em>Depends on extensions</em> to select the extension that this materialized view
depends on (for example, edbspl). If set, dropping the extension will automatically drop the
materialized view as well.</p></li>
</ul>
<p>Click the <em>Code</em> tab to continue.</p>
<img alt="Materialized view dialog code tab" class="align-center" src="_images/materialized_view_code.png" />
<p>Use the text editor field in the <em>Code</em> tab to provide the query that will
...
Indexes and other dependent objects.</p>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="package_dialog.html" title="Package Dialog">next</a> |</li>
            <li class="right" ><a href="language_dialog.html" title="Language Dialog">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
