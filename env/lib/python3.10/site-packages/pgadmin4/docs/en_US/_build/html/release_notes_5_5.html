...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 5.5 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 5.4" href="release_notes_5_4.html" />
    <link rel="prev" title="Version 5.6" href="release_notes_5_6.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">Version 5.5</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-5-5">
<h1>Version 5.5<a class="headerlink" href="#version-5-5" title="Link to this heading">¶</a></h1>
<p>Release date: 2021-07-15</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin4 5.4.</p>
<section id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/1975">Issue #1975</a> -  Highlighted long running queries on the dashboards.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3893">Issue #3893</a> -  Added support for Reassign/Drop Owned for login roles.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3920">Issue #3920</a> -  Do not block the query editor window when running a query.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5940">Issue #5940</a> -  Added support for OAuth 2 authentication.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6559">Issue #6559</a> -  Added option to provide maximum width of the column when ‘Resize by data?’ option in the preferences is set to True.</div>
</div>
</section>
...
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4189">Issue #4189</a> -  Ensure that the Data Output panel can be snapped back after it is detached.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6388">Issue #6388</a> -  Fixed replace keyboard shortcut issue in the query tool on the normal keyboard layout.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6398">Issue #6398</a> -  Fixed an issue where detaching the query editor panel gives a blank white panel.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6427">Issue #6427</a> -  Remove leading whitespace and replace it with ‘[…] ‘ in the Query Tool data grid so cells don’t look empty.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6448">Issue #6448</a> -  Fixed an issue in the search object when searching in ‘all types’ or ‘subscription’ if the user doesn’t have access to the subscription.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6489">Issue #6489</a> -  Fixed an issue where Execute/Refresh button should not be disabled when we run the empty query.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6505">Issue #6505</a> -  Fixed an issue where the New Connection Drop Down has lost default maintenance database, auto-select, and tab-through functionality.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6536">Issue #6536</a> -  Fixed directory selection issue with the folder dialog.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6541">Issue #6541</a> -  Ensure that setting ‘Open in new browser tab’ should be visible, it should not be based on the value of ‘ENABLE_PSQL’.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6547">Issue #6547</a> -  Fixed copy/paste issues for PSQL tool terminal.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6550">Issue #6550</a> -  Disable email deliverability check that was introduced in flask-security-too by default to maintain backwards compatibility.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6555">Issue #6555</a> -  Fixed Czech translation string for ‘Login’ keyword.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6557">Issue #6557</a> -  Fixed an issue where incorrect column name listed in the properties of Index.</div>
</div>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 5.5</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 5.5</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_5_4.html" title="Version 5.4">next</a> |</li>
            <li class="right" ><a href="release_notes_5_6.html" title="Version 5.6">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
