...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Container Deployment &#8212; pgAdmin 4 9.11 documentation</title>
...
<span class="w">    </span><span class="s1">&#39;pg-18&#39;</span>:<span class="w"> </span><span class="s1">&#39;/usr/local/pgsql-18&#39;</span>,
<span class="w">    </span><span class="s1">&#39;pg-17&#39;</span>:<span class="w"> </span><span class="s1">&#39;/usr/local/pgsql-17&#39;</span>,
...
<p>this may be changed in the <a class="reference internal" href="preferences.html#preferences"><span class="std std-ref">Preferences</span></a>.</p>
</section>
...
<p><strong>PGADMIN_REPLACE_SERVERS_ON_STARTUP</strong></p>
<p><em>Default: null</em></p>
<p>By default, the server definitions are only loaded on first launch, i.e. when initializing the configuration database. See PGADMIN_SERVER_JSON_FILE above.</p>
<p>If this variable is set to True, the server definitions will be replaced on every launch. This can be used to declaratively manage the server definitions.</p>
...
<p><strong>PGADMIN_CUSTOM_CONFIG_DISTRO_FILE</strong></p>
<p><em>Default: /pgadmin4/config_distro.py</em></p>
<p>Override the default file path for the pgadmin configurations file.This can be used while provisioning
container with read only root file system to achieve a more secure pgadmin4 deployment for kubernetes.
Note that if you are externally mapping this file, then environment variables passed using <em>PGADMIN_CONFIG_</em>
suffix will be ignored.</p>
<p><strong>PGPASS_FILE</strong></p>
<p><em>Default: &lt;null&gt;</em>
This varible should be set to if you want to pass password using pgpass
file for the servers added in pgadmin.</p>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="login.html" title="Login Page">next</a> |</li>
            <li class="right" ><a href="server_deployment.html" title="Server Deployment">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
