...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Lock/Restore Account &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Enabling LDAP Authentication" href="ldap.html" />
    ...
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">Lock/Restore Account</a></li> 
      </ul>
    </div>  
  ...
  <section id="lock-restore-account">
<span id="restore-locked-user"></span><h1><span class="target" id="index-0"></span>Lock/Restore Account<a class="headerlink" href="#lock-restore-account" title="Link to this heading">¶</a></h1>
<p>Account locking/unlocking via user management dialog:</p>
<p>An admin can lock and unlock user from the user management dialog. This allows the admin to lock or restore
the user when there are several failed login attempts. This page guides you through configuring per-user
locking/restoring. For more details visit <a class="reference internal" href="user_management.html#user-management"><span class="std std-ref">User management</span></a>.</p>
...
<tbody>
<tr class="row-even"><td><p>MAX_LOGIN_ATTEMPTS</p></td>
<td><p>Which sets the number of failed login that
are allowed. If this value is exceeded, the account is locked and can be reset by an administrator.
By setting the variable to the value zero this feature is deactivated.</p></td>
</tr>
</tbody>
</table>
<p>When Administrator itself gets locked, following steps may be considered to restore it:</p>
<ul class="simple">
<li><p>Increase MAX_LOGIN_ATTEMPTS, and try to successfully login to restore the account.</p></li>
</ul>
<p>OR</p>
<p>By updating configuration database</p>
<p>SQLite DB (pgAdmin4.db):</p>
<ul class="simple">
<li><p>Locate the pgAdmin4.db file and open it using any DB Browser (or DB Browser for SQLite)</p></li>
<li><p>After opening the DB file, head towards ‘Execute SQL’ section.</p></li>
<li><p>Run below query -</p></li>
</ul>
<p><em>UPDATE USER SET LOCKED = false, LOGIN_ATTEMPTS = 0 WHERE USERNAME = &lt;YOUR_EMAIL_ID&gt;</em></p>
<p>External database:</p>
<ul class="simple">
...
<p><em>UPDATE USER SET LOCKED = false, LOGIN_ATTEMPTS = 0 WHERE USERNAME = &lt;YOUR_EMAIL_ID&gt;</em></p>
<ul class="simple">
<li><p>Make sure the query changes are committed.</p></li>
</ul>
<p>Account locking by failed login attempts:</p>
<img alt="Failed login attempt for current user" class="align-center" src="_images/login_attempt_user.png" />
<p>pgAdmin application is configured to lock a user account when a number of consecutive failed login attempts are
exceeded.</p>
<p>MAX_LOGIN_ATTEMPTS is defaulted to 3 unsuccessful login attempts, after which the account would be locked.</p>
<p>The only way to restore the user account is by contacting the Administrator and ask to unlock it.</p>
</section>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Lock/Restore Account</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="ldap.html" title="Enabling LDAP Authentication">next</a> |</li>
            <li class="right" ><a href="change_user_password.html" title="Change User Password Dialog">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
