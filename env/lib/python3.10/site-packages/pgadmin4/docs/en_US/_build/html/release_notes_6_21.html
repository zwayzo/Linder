...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 6.21 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 6.20" href="release_notes_6_20.html" />
    <link rel="prev" title="Version 7.0" href="release_notes_7_0.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_6_20.html" title="Version 6.20"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 6.21</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-6-21">
<h1>Version 6.21<a class="headerlink" href="#version-6-21" title="Link to this heading">¶</a></h1>
<p>Release date: 2023-03-09</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin 4 v6.20.</p>
...
<p><strong>psql</strong>, <strong>pg_dump</strong>, <strong>pg_dumpall</strong>, <strong>pg_restore</strong>: 15.1</p>
</section>
<section id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Link to this heading">¶</a></h2>
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5832">Issue #5832</a> -  Allow changing cardinality notation in ERD to use Chen notation.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5842">Issue #5842</a> -  Add additional logging for successful logins and user creation.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5269">Issue #5269</a> -  Ensure that the schema diff tool should pick up the change in the column grants.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5685">Issue #5685</a> -  Ensure that Grant column permission to a view is visible in the SQL tab.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5747">Issue #5747</a> -  Ensure that content on the DDL comparison panel should get refreshed on selecting the object using the up and down arrow keys.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5756">Issue #5756</a> -  Fix for query tool prompting for unsaved changes even if no changes have been made.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5758">Issue #5758</a> -  Fixed an issue where lock layout menu was not in sync with preferences.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5760">Issue #5760</a> -  Fixed an issue where query was not pasted to editor after trojan source warning.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5764">Issue #5764</a> -  Fix an issue where the maintenance dialog for Materialized View gives an error.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5773">Issue #5773</a> -  Fixed an issue where Clear Saved Password should be disabled if the password is already cleared.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5790">Issue #5790</a> -  Fixed an issue where the user can’t create trigger AFTER UPDATE OF.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5803">Issue #5803</a> -  Fix an issue where query tool is stripping spaces in grid cell.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5810">Issue #5810</a> -  Fix an issue where sequence owner is remove on sequence edit.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5822">Issue #5822</a> -  Do not allow to save invalid JSON in query tool JSON editor.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5847">Issue #5847</a> -  Fixed an issue where pgAdmin failed to connect when the Postgres password included special characters.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5870">Issue #5870</a> -  Ensure that the database migration does not fail with a NoSuchTableError exception.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5872">Issue #5872</a> -  Handle MERGE operation in query tool explain introduced in PostgreSQL 15.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5889">Issue #5889</a> -  Fixed an issue where the database server is not connected using a service file.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5909">Issue #5909</a> -  Fixed an issue where the file name in the query tool tab was not changing if another file is opened.</div>
</div>
</div></blockquote>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 6.21</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 6.21</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_6_20.html" title="Version 6.20">next</a> |</li>
            <li class="right" ><a href="release_notes_7_0.html" title="Version 7.0">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
