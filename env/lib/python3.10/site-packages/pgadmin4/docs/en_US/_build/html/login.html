...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Login Page &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Enabling two-factor authentication (2FA)" href="mfa.html" />
    ...
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="mfa.html" title="Enabling two-factor authentication (2FA)"
        ...
        <li class="nav-item nav-item-this"><a href="">Login Page</a></li> 
      </ul>
    </div>  
...
<span id="login"></span><h1><span class="target" id="index-0"></span>Login Page<a class="headerlink" href="#login-page" title="Link to this heading">¶</a></h1>
<p>Use the <em>Login</em> page to log in to pgAdmin:</p>
<img alt="pgAdmin login page" class="align-center" src="_images/login.png" />
<p>Use the fields in the <em>Login</em> page to authenticate your connection. There are
...
<h2>Recovering a Lost Password<a class="headerlink" href="#recovering-a-lost-password" title="Link to this heading">¶</a></h2>
...
<p>Please note that your LDAP password cannot be recovered using this page. If
...
<h2>Avoiding a bruteforce attack<a class="headerlink" href="#avoiding-a-bruteforce-attack" title="Link to this heading">¶</a></h2>
...
You can disable this feature by setting the value to zero.</p>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Login Page</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Login Page</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="mfa.html" title="Enabling two-factor authentication (2FA)">next</a> |</li>
            <li class="right" ><a href="container_deployment.html" title="Container Deployment">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
