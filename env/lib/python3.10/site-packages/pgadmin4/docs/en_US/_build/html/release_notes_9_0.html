...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 9.0 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 8.14" href="release_notes_8_14.html" />
    <link rel="prev" title="Version 9.1" href="release_notes_9_1.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_8_14.html" title="Version 8.14"
             accesskey="N">next</a> |</li>
        <li class="right" >
          <a href="release_notes_9_1.html" title="Version 9.1"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 9.0</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-9-0">
<h1>Version 9.0<a class="headerlink" href="#version-9-0" title="Link to this heading">¶</a></h1>
<p>Release date: 2025-02-06</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin 4 v8.14.</p>
...
<p><strong>PostgreSQL</strong>: 13, 14, 15, 16 and 17</p>
<p><strong>EDB Advanced Server</strong>: 13, 14, 15, 16 and 17</p>
</section>
...
<p><strong>psql</strong>, <strong>pg_dump</strong>, <strong>pg_dumpall</strong>, <strong>pg_restore</strong>: 17.0</p>
</section>
<section id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Link to this heading">¶</a></h2>
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6513">Issue #6513</a> -  Change button labels and color in delete confirmation dialog for all objects to improve UX.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7708">Issue #7708</a> -  Enhanced pgAdmin 4 with support for Workspace layouts.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8332">Issue #8332</a> -  Added the MAINTAIN privilege for PostgreSQL version 17 and above.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8391">Issue #8391</a> -  Add support for OAuth2 profile array response, which also takes care of the GitHub Private Email ID issue.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8249">Issue #8249</a> -  Show the python version used for the pgAdmin server in the about dialog.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/3273">Issue #3273</a> -  Change the logic of setval function, so that the next nextval of sequence will return exactly the specified value.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5204">Issue #5204</a> -  Fixed an issue where pgadmin cannot install into path with non ASCII characters.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6044">Issue #6044</a> -  Fixed an issue where filter dialog save fails when the PostgreSQL server/database connection is lost.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6968">Issue #6968</a> -  Fixed an issue where option key was not registering in PSQL tool.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8072">Issue #8072</a> -  Fixed an issue where Schema Diff not produce difference script for Index definition with where condition.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8142">Issue #8142</a> -  Correct the documentation for the MFA configuration.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8165">Issue #8165</a> -  Fixed an issue where error message from the database server need space between two sentences.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8199">Issue #8199</a> -  Fixed an issue where query tool throws utf-8 decode error when using cursor with binary data.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8208">Issue #8208</a> -  Allow deleting the entry while creating/adding new label to enumeration type.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8209">Issue #8209</a> -  Fixed an issue where properties dialog throwing an error for Materialized View.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8254">Issue #8254</a> -  Fix a formatting issue in View/Edit tool generated SQL where some filters are applied.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8255">Issue #8255</a> -  Fixed an issue where tooltip on a dropdown button is blocking access to dropdown menu.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8256">Issue #8256</a> -  Fix the error occurring while loading preferences on startup.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8273">Issue #8273</a> -  Fixed an issue where copying query tool output cell is not working if any SQL text is selected.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8299">Issue #8299</a> -  Ensure master password pop up is not shown on setting MASTER_PASSWORD_REQUIRED to false.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8309">Issue #8309</a> -  Remove the option “With no data (concurrently)” from Refresh MATERIALIZED VIEW context menu.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8320">Issue #8320</a> -  Fix an issue where wrong information is shown after using the filter on the Dashboard&gt; State tab.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8365">Issue #8365</a> -  Fixed an issue where PSQL tool is not opening if database name have HTML characters in the name.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8369">Issue #8369</a> -  Fixed an issue where Default Privileges and Privileges not working correctly.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8408">Issue #8408</a> -  Fixed an issue where quotes were missing in the CREATE script for the tablespace.</div>
</div>
</div></blockquote>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 9.0</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 9.0</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_8_14.html" title="Version 8.14">next</a> |</li>
            <li class="right" ><a href="release_notes_9_1.html" title="Version 9.1">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
