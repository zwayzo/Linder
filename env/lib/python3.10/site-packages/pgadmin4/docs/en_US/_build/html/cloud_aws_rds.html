...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Amazon RDS Cloud Deployment &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="cloud_edb_biganimal.html" title="EDB BigAnimal Cloud Deployment">next</a> |</li>
            <li class="right" ><a href="cloud_deployment.html" title="PostgreSQL Cloud Deployment">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
