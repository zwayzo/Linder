...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 6.0 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 5.7" href="release_notes_5_7.html" />
    <link rel="prev" title="Version 6.1" href="release_notes_6_1.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_5_7.html" title="Version 5.7"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 6.0</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-6-0">
<h1>Version 6.0<a class="headerlink" href="#version-6-0" title="Link to this heading">¶</a></h1>
<p>Release date: 2021-10-07</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin4 5.7.</p>
<section id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4211">Issue #4211</a> -  Added support for OWNED BY Clause for sequences.</div>
</div>
</section>
<section id="housekeeping">
<h2>Housekeeping<a class="headerlink" href="#housekeeping" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5741">Issue #5741</a> -  Revisit all the CREATE and DROP DDL’s to add appropriate ‘IF EXISTS’, ‘CASCADE’ and ‘CREATE OR REPLACE’.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6129">Issue #6129</a> -  Port browser tree to React.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6588">Issue #6588</a> -  Port object nodes and properties dialogs to React.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6687">Issue #6687</a> -  Port Grant Wizard to react.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6692">Issue #6692</a> -  Remove GPDB support completely.</div>
</div>
</section>
<section id="bug-fixes">
<h2>Bug fixes<a class="headerlink" href="#bug-fixes" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/2097">Issue #2097</a> -  Fixed an issue where grant wizard is unresponsive if the database size is huge.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/2546">Issue #2546</a> -  Added support to create the Partitioned table using COLLATE and opclass.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3827">Issue #3827</a> -  Ensure that in the Query History tab, query details should be scrollable.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6712">Issue #6712</a> -  Fixed an issue where collapse and expand arrows mismatch in case of nested IF.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6713">Issue #6713</a> -  Fixed an issue where the last message is not visible in the Debugger.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6723">Issue #6723</a> -  Updated query error row selection color as per dark theme style guide.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6724">Issue #6724</a> -  Fixed an issue where the drop cascade button enables for Databases.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6736">Issue #6736</a> -  Fixed an issue where Refresh view options are not working for materialized view.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6755">Issue #6755</a> -  Fixed keyerror issue in schema diff for ‘attnum’ and ‘edit_types’ parameter.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6759">Issue #6759</a> -  Ensure that RLS names should not be editable in the collection node of properties tab.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6798">Issue #6798</a> -  Fixed an issue where Execute button of the query tool gets disabled once we change anything in the data grid.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6834">Issue #6834</a> -  Ensure that SQL help should work for EPAS servers.</div>
</div>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 6.0</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 6.0</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_5_7.html" title="Version 5.7">next</a> |</li>
            <li class="right" ><a href="release_notes_6_1.html" title="Version 6.1">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
