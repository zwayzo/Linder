...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 7.2 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 7.1" href="release_notes_7_1.html" />
    <link rel="prev" title="Version 7.3" href="release_notes_7_3.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_7_3.html" title="Version 7.3"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 7.2</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-7-2">
<h1>Version 7.2<a class="headerlink" href="#version-7-2" title="Link to this heading">¶</a></h1>
<p>Release date: 2023-06-01</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin 4 v7.1.</p>
...
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/3831">Issue #3831</a> -  Add Option to only show active connections on Dashboard.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/4769">Issue #4769</a> -  Allow pgAdmin to retrive master password from external script/program.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5048">Issue #5048</a> -  Add an option to hide/show empty object collection nodes.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5123">Issue #5123</a> -  Added support to use standard OS secret store to save server/ssh tunnel passwords instead of master password in pgAdmin desktop mode.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5868">Issue #5868</a> -  Implement new PostgreSQL 15 features in publication dialog and SQL.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5789">Issue #5789</a> -  Fixed an issue where Foreign Key columns are shown in the wrong order in SQL and Properties.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5817">Issue #5817</a> -  Ensure that a new row should be added on top in the User Management dialog.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5926">Issue #5926</a> -  Fixed an issue where REVOKE ALL DDL in table SQL was added only for one role.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6003">Issue #6003</a> -  Indicate the user if all the server’s children nodes are hidden from the preferences setting.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6026">Issue #6026</a> -  Tools menu should be toggled for “pause replay of wal” and “resume replay of wal”.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6043">Issue #6043</a> -  Make the ‘Connect to server’ dialog a modal dialog.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6080">Issue #6080</a> -  pgAdmin icon not showing on taskbar on Windows 10.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6127">Issue #6127</a> -  Fixed an issue where properties were not visible for FTS Parsers, FTS Templates, MViews, and Rules in Catalog objects.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6147">Issue #6147</a> -  Heartbeat is getting logged, though no server is connected in pgAdmin.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6204">Issue #6204</a> -  Ensure that name can’t be empty in edit mode for Primary Key and Index.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6221">Issue #6221</a> -  Fix circular reference error for the multirange data types in the query tool.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6247">Issue #6247</a> -  Fixed an issue where PSQL tool prompts for password if using password exec command.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6253">Issue #6253</a> -  Fix an issue in the register server when setting the role, an arbitrary SQL query can be fired.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6267">Issue #6267</a> -  Ensure the user is able to log in if the specified OAUTH2_USERNAME_CLAIM is present in the OAuth2 profile.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6278">Issue #6278</a> -  Use dependent instead of dependant in the message.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6279">Issue #6279</a> -  Fix incorrect number of foreign tables displayed. Show column comments in RE-SQL.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6280">Issue #6280</a> -  View SQL tab not quoting column comments.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6281">Issue #6281</a> -  VarChar Field Sizes are missing from Query’s Grid header.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6331">Issue #6331</a> -  Separate multiple Blocking PIDs with delimiter on Dashboard.</div>
</div>
</div></blockquote>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 7.2</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 7.2</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_7_1.html" title="Version 7.1">next</a> |</li>
            <li class="right" ><a href="release_notes_7_3.html" title="Version 7.3">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
