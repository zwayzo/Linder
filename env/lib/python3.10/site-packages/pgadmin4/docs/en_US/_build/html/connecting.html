...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Connecting To A Server &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="server_group_dialog.html" title="Server Group Dialog">next</a> |</li>
            <li class="right" ><a href="external_database.html" title="External database for pgAdmin user settings">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
