...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>User Interface &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="prev" title="Enabling Webserver Authentication" href="webserver.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">User Interface</a></li> 
      </ul>
    </div>  
...
<span id="id1"></span><h1><span class="target" id="index-0"></span>User Interface<a class="headerlink" href="#user-interface" title="Link to this heading">¶</a></h1>
...
two panes: the <em>Object Explorer</em> tree control in the left pane, and a tabbed browser in
the right pane.</p>
...
<a class="reference internal" href="server_dialog.html#server-dialog"><span class="std std-ref">Register - Server dialog</span></a> to add a new server definition.</p></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="menu_bar.html" title="Menu Bar">next</a> |</li>
            <li class="right" ><a href="webserver.html" title="Enabling Webserver Authentication">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
