...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Extension Dialog &#8212; pgAdmin 4 9.11 documentation</title>
...
<li><p>Move the switch next to <em>Cascade?</em> to the <em>Yes</em> position to automatically
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="foreign_data_wrapper_dialog.html" title="Foreign Data Wrapper Dialog">next</a> |</li>
            <li class="right" ><a href="event_trigger_dialog.html" title="Event Trigger Dialog">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
