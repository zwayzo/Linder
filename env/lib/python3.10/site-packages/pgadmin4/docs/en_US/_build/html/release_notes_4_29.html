...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 4.29 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 4.28" href="release_notes_4_28.html" />
    <link rel="prev" title="Version 4.30" href="release_notes_4_30.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">Version 4.29</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-4-29">
<h1>Version 4.29<a class="headerlink" href="#version-4-29" title="Link to this heading">¶</a></h1>
<p>Release date: 2020-12-10</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin4 4.28.</p>
...
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5328">Issue #5328</a> -  Improve code coverage and API test cases for Foreign Tables.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5337">Issue #5337</a> -  Improve code coverage and API test cases for Views and Materialized Views.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5343">Issue #5343</a> -  Improve code coverage and API test cases for Debugger.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6062">Issue #6062</a> -  Ensure that code coverage should cover class and function declarations.</div>
</div>
</section>
<section id="bug-fixes">
<h2>Bug fixes<a class="headerlink" href="#bug-fixes" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5886">Issue #5886</a> -  Fixed false error is shown while adding a new foreign key from the table dialog when a foreign key already exists with Auto FK Index set to true.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5943">Issue #5943</a> -  Ensure that folder rename should work properly in Storage Manager.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5974">Issue #5974</a> -  Fixed an issue where the debugger’s custom tab title not applied when opened in the new browser tab.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5978">Issue #5978</a> -  Fixed an issue where dynamic tab title has not applied the first time for debugger panel.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5982">Issue #5982</a> -  Fixed documentation issue where JSON is not valid.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5983">Issue #5983</a> -  Added the appropriate server icon based on the server type in the new connection dialog.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5985">Issue #5985</a> -  Fixed an issue where the process watcher dialog throws an error for the database server which is already removed.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5991">Issue #5991</a> -  Ensure that dirty indicator (*) should not be visible when renaming the tabs.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5992">Issue #5992</a> -  Fixed an issue where escape character is shown when the server/database name has some special characters.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5998">Issue #5998</a> -  Fixed an issue where schema diff doesn’t show the result of compare if source schema has tables with RLS.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6003">Issue #6003</a> -  Fixed an issue where an illegal argument is showing for trigger SQL when a trigger is created for View.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6022">Issue #6022</a> -  Fixed an issue where shared servers import is failing.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6072">Issue #6072</a> -  Fixed DLL load failed while importing bcrypt.</div>
</div>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 4.29</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.29</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_4_28.html" title="Version 4.28">next</a> |</li>
            <li class="right" ><a href="release_notes_4_30.html" title="Version 4.30">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
