...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>ERD Tool &#8212; pgAdmin 4 9.11 documentation</title>
...
<td><p>Click the <em>Download image</em> icon to save the ERD diagram in an image format.</p></td>
<td><p>Option/Alt +
Ctrl + I</p></td>
</tr>
</tbody>
...
<tbody>
<tr class="row-even"><td><p><em>Search table</em></p></td>
<td><p>Click to search for a table in the diagram. Selecting a table from the search results will bring
it into view and highlight it.</p></td>
<td><p>Option/Alt +
Ctrl + F</p></td>
</tr>
<tr class="row-odd"><td><p><em>Add table</em></p></td>
...
<tr class="row-even"><td><p><em>Edit table</em></p></td>
...
<tr class="row-odd"><td><p><em>Clone table</em></p></td>
...
<tr class="row-even"><td><p><em>Drop table/link</em></p></td>
...
<tbody>
<tr class="row-even"><td><p><em>1-1</em></p></td>
<td><p>Click this button to open a one-to-one relationship dialog to add a relationship between the
two tables. The selected table becomes the referencing table.</p></td>
<td><p>Option/Alt +
Ctrl + B</p></td>
</tr>
<tr class="row-odd"><td><p><em>1-M</em></p></td>
...
<tr class="row-even"><td><p><em>M-M</em></p></td>
...
identify a group of tables. Once set, all the newly added tables will take the same color.</p></td>
</tr>
...
<td><p>Click this button to auto-align all tables and links to make them look cleaner.</p></td>
<td><p>Option/Alt +
Ctrl + L</p></td>
</tr>
...
<li><p>It can be used to edit an existing table or add a new one.</p></li>
...
<section id="the-one-to-one-link-dialog">
<h2>The One to One Link Dialog<a class="headerlink" href="#the-one-to-one-link-dialog" title="Link to this heading">¶</a></h2>
<img alt="ERD tool 1-1 dialog" class="align-center" src="_images/erd_11_dialog.png" />
<p>The one to one link dialog allows you to:</p>
<ul class="simple">
<li><p>Add a one to one relationship between two tables.</p></li>
<li><p><em>Local Table</em> is the table that references a table and has the <em>one</em> end point.</p></li>
<li><p><em>Local Column</em> the column that references.</p></li>
<li><p><em>Select Constraint</em> To implement a one-to-one relationship, the <em>Local Column</em> must have a primary key or unique constraint. The default is a unique constraint. Please note that this field is visible only when the selected <em>Local Column</em> does not have either of the mentioned constraints.</p></li>
...
<li><a class="reference internal" href="#the-one-to-one-link-dialog">The One to One Link Dialog</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="psql_tool.html" title="PSQL Tool">next</a> |</li>
            <li class="right" ><a href="schema_diff.html" title="Schema Diff">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
