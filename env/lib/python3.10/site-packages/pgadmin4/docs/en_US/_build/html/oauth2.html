...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Enabling OAUTH2 Authentication &#8212; pgAdmin 4 9.11 documentation</title>
...
<tr class="row-odd"><td><p>OAUTH2_CHALLENGE_METHOD</p></td>
<td><p>Enable PKCE workflow. PKCE method name, only <em>S256</em> is supported</p></td>
</tr>
<tr class="row-even"><td><p>OAUTH2_RESPONSE_TYPE</p></td>
<td><p>Enable PKCE workflow. Mandatory with OAUTH2_CHALLENGE_METHOD, must be set to <em>code</em></p></td>
</tr>
</tbody>
</table>
...
<section id="pkce-workflow">
<h2>PKCE Workflow<a class="headerlink" href="#pkce-workflow" title="Link to this heading">¶</a></h2>
<p>Ref: <a class="reference external" href="https://oauth.net/2/pkce">https://oauth.net/2/pkce</a></p>
<p>To enable PKCE workflow, set the configuration parameters OAUTH2_CHALLENGE_METHOD to <em>S256</em> and OAUTH2_RESPONSE_TYPE to <em>code</em>.
Both parameters are mandatory to enable PKCE workflow.</p>
</section>
</section>
...
<li><a class="reference internal" href="#pkce-workflow">PKCE Workflow</a></li>
</ul>
</li>
</ul>
