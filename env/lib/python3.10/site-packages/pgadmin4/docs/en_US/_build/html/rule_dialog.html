...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Rule Dialog &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="prev" title="RLS Policy Dialog" href="rls_policy_dialog.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="rls_policy_dialog.html" title="RLS Policy Dialog"
        ...
        <li class="nav-item nav-item-this"><a href="">Rule Dialog</a></li> 
      </ul>
    </div>  
  ...
  <section id="rule-dialog">
<span id="id1"></span><h1><span class="target" id="index-0"></span>Rule Dialog<a class="headerlink" href="#rule-dialog" title="Link to this heading">¶</a></h1>
...
<em>Definition</em>, <em>Condition</em>, <em>Commands</em> tabs. The <em>SQL</em> tab displays the SQL code
...
<img alt="Trigger enabled in dialog tab" class="align-center" src="_images/rule_definition_enabled.png" />
<ul class="simple">
<li><p><em>Rule enabled</em> field is available in rule dialog once the rule is created.
You can select one of the four options available.</p></li>
</ul>
<p>Click the <em>Condition</em> tab to continue.</p>
<img alt="Rule dialog condition tab" class="align-center" src="_images/rule_condition.png" />
<p>Specify a SQL conditional expression that returns a boolean value in the editor.</p>
<p>Click the <em>Commands</em> tab to continue.</p>
<img alt="Rule dialog commands tab" class="align-center" src="_images/rule_commands.png" />
<p>Provide a command in the editor that defines the action performed by the rule.</p>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="table_dialog.html" title="Table Dialog">next</a> |</li>
            <li class="right" ><a href="rls_policy_dialog.html" title="RLS Policy Dialog">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
