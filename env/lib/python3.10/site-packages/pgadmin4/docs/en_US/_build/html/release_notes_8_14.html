...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 8.14 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 8.13" href="release_notes_8_13.html" />
    <link rel="prev" title="Version 9.0" href="release_notes_9_0.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_8_13.html" title="Version 8.13"
             accesskey="N">next</a> |</li>
        <li class="right" >
          <a href="release_notes_9_0.html" title="Version 9.0"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 8.14</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-8-14">
<h1>Version 8.14<a class="headerlink" href="#version-8-14" title="Link to this heading">¶</a></h1>
<p>Release date: 2024-12-12</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin 4 v8.13.</p>
...
<p><strong>EDB Advanced Server</strong>: 12, 13, 14, 15, 16 and 17</p>
</section>
...
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/3317">Issue #3317</a> -  Allow setting NULL ordering for columns in view/edit data filter dialog.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/3751">Issue #3751</a> -  Show auto-complete column names in filtered rows dialog of table and filter options of view/edit data tool.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5786">Issue #5786</a> -  Allow the use of a pgpass file in the pgAdmin container via Docker secrets.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6592">Issue #6592</a> -  Fixed multiple issues and improved ERD auto-layout.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6794">Issue #6794</a> -  Add support for passing connection details as placeholders in the passexec command.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7330">Issue #7330</a> -  Add support to deploy pgAdmin in a container with readOnlyRootFilesystem to true.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8095">Issue #8095</a> -  Added support for a builtin locale provider in the Database dialog.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8192">Issue #8192</a> -  Added support for adding tags on a server node.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5099">Issue #5099</a> -  Fixed an issue where Ctrl/Cmd + A was not selecting all data in query tool data grid.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7384">Issue #7384</a> -  Fixed an issue where querying a foreign table gives the error ‘ForeignTableCommand’ object has no attribute ‘auto_commit’.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7486">Issue #7486</a> -  Fixed an issue where indent with space was not aligning to next tab position.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7809">Issue #7809</a> -  Fixed an issue where pgAdmin crashes on accessing the dashboard state tab when database is super busy.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7865">Issue #7865</a> -  Fixed an issue related to the query tool update connection after the server disconnected from the object explorer.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7892">Issue #7892</a> -  Fixed an issue where a column name change in the edit dialog of the table node does not show the updated column name.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8010">Issue #8010</a> -  Fixed an issue where query tool should show results and messages only from the last executed query.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8028">Issue #8028</a> -  Fixed an issue where query tool throws syntax error if a newly added row is untouched and saved.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8065">Issue #8065</a> -  Ensure the crypt key is retrieved correctly on backend server restart.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8098">Issue #8098</a> -  Fixed an issue in schema diff where an error message popup was showing some garbage without any info.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8127">Issue #8127</a> -  Fixed an issue where query tool should not prompt for unsaved changes when there are no changes.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8134">Issue #8134</a> -  Add a user preference to enable/disable alternating row background colors in the data output of query tool.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8157">Issue #8157</a> -  Fixed an issue where doing Ctrl/Cmd+C on a selected text in a cell editor of data output in the query tool copied the complete text.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8158">Issue #8158</a> -  Fixed an issue where auto-width of wide columns in data output is incorrectly calculated.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8215">Issue #8215</a> -  Ensure correct custom SSL certificate passed in connection string.</div>
</div>
</div></blockquote>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 8.14</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 8.14</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_8_13.html" title="Version 8.13">next</a> |</li>
            <li class="right" ><a href="release_notes_9_0.html" title="Version 9.0">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
