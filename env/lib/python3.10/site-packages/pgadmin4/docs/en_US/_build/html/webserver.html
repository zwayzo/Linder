...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Enabling Webserver Authentication &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="prev" title="Enabling OAUTH2 Authentication" href="oauth2.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">Enabling Webserver Authentication</a></li> 
      </ul>
    </div>  
...
<p>If REMOTE_USER does not work, try replacing it with either REMOTE-USER or Remote-user.</p>
</div>
...
it will be used as an encryption key while storing the password. If it is False, the server password can not be stored.</p>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Enabling Webserver Authentication</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Enabling Webserver Authentication</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="user_interface.html" title="User Interface">next</a> |</li>
            <li class="right" ><a href="oauth2.html" title="Enabling OAUTH2 Authentication">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
