...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Toolbar &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">Toolbar</a></li> 
      </ul>
    </div>  
  ...
  <section id="toolbar">
<span id="id1"></span><h1><span class="target" id="index-0"></span>Toolbar<a class="headerlink" href="#toolbar" title="Link to this heading">¶</a></h1>
...
the selected object node.</p>
<img alt="pgAdmin Toolbar" class="align-center" src="_images/toolbar.png" />
<ul class="simple">
<li><p>Use the <a class="reference internal" href="#object-explorer-filter"><span class="std std-ref">Object filter</span></a> button to access
the Object Filter popup. It helps you filter objects in the Object Explorer tree.</p></li>
...
selected table.</p></li>
<li><p>Use the <a class="reference internal" href="viewdata_filter.html#viewdata-filter"><span class="std std-ref">Filtered Rows</span></a> button to access the Data Filter popup
to apply a filter to a set of data for viewing/editing.</p></li>
<li><p>Use the <a class="reference internal" href="search_objects.html#search-objects"><span class="std std-ref">Search objects</span></a> button to access the search objects
dialog. It helps you search any database object.</p></li>
<li><p>Use the <a class="reference internal" href="psql_tool.html#psql-tool"><span class="std std-ref">PSQL Tool</span></a> button to open the PSQL in the current
database context.</p></li>
</ul>
</section>
<section id="object-explorer-filter">
<span id="id2"></span><h1><span class="target" id="index-1"></span>Object Explorer Filter<a class="headerlink" href="#object-explorer-filter" title="Link to this heading">¶</a></h1>
<img alt="Object Explorer Filter Dialog" class="align-center" src="_images/object_explorer_filter.png" />
<p>Use this tool to filter objects in the Object Explorer by
following fields:</p>
<ul class="simple">
<li><p>Use the <em>Tags</em> field to filter the servers with one or more server tags. The
servers with any of the selected tags will be displayed in the Object Explorer.
You can also create a new tag by typing in the field and pressing Enter.</p></li>
</ul>
<p>Click the <strong>Apply</strong> button to apply the filter. Please note the object explorer will
refresh after applying the filter.</p>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Toolbar</a></li>
<li><a class="reference internal" href="#object-explorer-filter">Object Explorer Filter</a></li>
</ul>
...
<li class="toctree-l2"><a class="reference internal" href="#object-explorer-filter">Object Explorer Filter</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="tabbed_browser.html" title="Tabbed Browser">next</a> |</li>
            <li class="right" ><a href="menu_bar.html" title="Menu Bar">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
