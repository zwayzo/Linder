...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 6.10 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 6.9" href="release_notes_6_9.html" />
    <link rel="prev" title="Version 6.11" href="release_notes_6_11.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_6_11.html" title="Version 6.11"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 6.10</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-6-10">
<h1>Version 6.10<a class="headerlink" href="#version-6-10" title="Link to this heading">¶</a></h1>
<p>Release date: 2022-06-02</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin 4 v6.9.</p>
<section id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Link to this heading">¶</a></h2>
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7364">Issue #7364</a> -  Added the ability to resize columns on dashboard tables.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7283">Issue #7283</a> -  PG 15 compatibility issues fixed.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7337">Issue #7337</a> -  Port connect server password dialog to React.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6962">Issue #6962</a> -  Fixed the browser tree overlapping nodes and expansion issue.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7002">Issue #7002</a> -  Added the ability to detect and warn users about bidirectional Unicode characters.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7347">Issue #7347</a> -  Ensure that when Authentication buttons are disabled their text is visible in the Dark and High contrast theme.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7368">Issue #7368</a> -  Ensure that unwanted APIs should not be getting called for BigAnimal.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7372">Issue #7372</a> -  Tell Docker to always pull the latest base images when building containers.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7373">Issue #7373</a> -  Fixed an issue with geometry window zoom mouse scroll not working.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7374">Issue #7374</a> -  Fixed an issue when switching between connections in the Query Tool dropdown, the background and foreground colors should be changed.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7376">Issue #7376</a> -  Fixed an issue where a popup for unsaved changes appears when clicking on the open file button for a blank query editor.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7380">Issue #7380</a> -  Added support for multi-cell selection in the query tool grid.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7383">Issue #7383</a> -  Fixed an issue where Preferences are not saved when the dialog is maximized.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7388">Issue #7388</a> -  Fixed an issue where an error message fills the entire window if the query is long.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7393">Issue #7393</a> -  Ensure that the editor position should not get changed once it is opened.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7394">Issue #7394</a> -  Fixed an issue where geometry is not visible when a single cell is selected.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7399">Issue #7399</a> -  Added missing toggle case keyboard shortcuts to the query tool.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7402">Issue #7402</a> -  Ensure that Dashboard graphs should be refreshed on changing the node from the browser tree.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7403">Issue #7403</a> -  Fixed an issue where comments on domain constraints were not visible when selecting a domain node.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7405">Issue #7405</a> -  Ensure that null values are accepted for the numeric columns in react-data-grid.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7408">Issue #7408</a> -  Fixed an issue when a table has a column with an array type with length or precision, the column type is not selected while editing the table.</div>
</div>
</div></blockquote>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 6.10</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 6.10</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_6_9.html" title="Version 6.9">next</a> |</li>
            <li class="right" ><a href="release_notes_6_11.html" title="Version 6.11">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
