...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 5.4 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 5.3" href="release_notes_5_3.html" />
    <link rel="prev" title="Version 5.5" href="release_notes_5_5.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_5_5.html" title="Version 5.5"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 5.4</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-5-4">
<h1>Version 5.4<a class="headerlink" href="#version-5-4" title="Link to this heading">¶</a></h1>
<p>Release date: 2021-06-17</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin4 5.3.</p>
<section id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/1561">Issue #1561</a> -  Added browse button to select the binary path in the Preferences.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/1591">Issue #1591</a> -  Added Grant Wizard option under Package node.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/2341">Issue #2341</a> -  Added support to launch PSQL for the connected database server.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4064">Issue #4064</a> -  Added window maximize/restore functionality for properties dialog.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5370">Issue #5370</a> -  Added support to set the binary path for the different database server versions.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6231">Issue #6231</a> -  Added OS, Browser, Configuration details in the About dialog.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6395">Issue #6395</a> -  Added support for rotating the pgAdmin log file on the basis of size and age.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6524">Issue #6524</a> -  Support non-admin installation on Windows.</div>
</div>
</section>
<section id="housekeeping">
<h2>Housekeeping<a class="headerlink" href="#housekeeping" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4622">Issue #4622</a> -  Added RESQL/MSQL test cases for Table and its child nodes.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6225">Issue #6225</a> -  Updated Flask-Security-Too to the latest v4.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6460">Issue #6460</a> -  Added a mechanism to detect a corrupt/broken config database file.</div>
</div>
</section>
<section id="bug-fixes">
<h2>Bug fixes<a class="headerlink" href="#bug-fixes" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4203">Issue #4203</a> -  Fixed the issue of renaming the database by another user.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6404">Issue #6404</a> -  Ensure that the Query Tool connection string should not be changed as per the ‘Query Tool tab title’.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6466">Issue #6466</a> -  Ensure that the user should be able to add members in Login/Role group while creating it.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6469">Issue #6469</a> -  Ensure that the calendar control should be disabled in the properties panel for Role.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6473">Issue #6473</a> -  Disable browser password saving in the runtime.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6478">Issue #6478</a> -  Fixed duplicate SQL issue for tables with more than one partition.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6482">Issue #6482</a> -  Fixed an issue where the Foreground Color property of server dialog does not work.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6513">Issue #6513</a> -  Fixed an issue where pgAdmin does not open after password reset in server mode.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6520">Issue #6520</a> -  Fixed an issue where a decimal number is appended for character varying fields while downloading the data in CSV format.</div>
</div>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 5.4</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 5.4</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_5_3.html" title="Version 5.3">next</a> |</li>
            <li class="right" ><a href="release_notes_5_5.html" title="Version 5.5">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
