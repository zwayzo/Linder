...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 8.13 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 8.12" href="release_notes_8_12.html" />
    <link rel="prev" title="Version 8.14" href="release_notes_8_14.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_8_12.html" title="Version 8.12"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 8.13</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-8-13">
<h1>Version 8.13<a class="headerlink" href="#version-8-13" title="Link to this heading">¶</a></h1>
<p>Release date: 2024-11-14</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin 4 v8.12.</p>
...
<p><strong>PostgreSQL</strong>: 12, 13, 14, 15, 16 and 17</p>
...
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/1780">Issue #1780</a> -  Replace infinite scrolling with pagination in query tool data output for better UX and performance.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/1984">Issue #1984</a> -  Add an object menu option to disconnect all server and database connections.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/2874">Issue #2874</a> -  Alternate the background color of rows to enhance readability.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5869">Issue #5869</a> -  Allow to pass PGADMIN_CONFIG_CONFIG_DATABASE_URI from docker secrets.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6016">Issue #6016</a> -  Format dashboard graph metrics for better readability.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7393">Issue #7393</a> -  Added support for auto-detecting and setting the End-of-line character (LF/CRLF) in the query tool editor.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7863">Issue #7863</a> -  Make the background color for the serial number and header cells distinct.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8061">Issue #8061</a> -  Updated the react-menu library from v2 to v4.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8077">Issue #8077</a> -  Remove bootstrap from the runtime code.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8077">Issue #8102</a> -  Remove the dependency on python packages eventlet and greenlet.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5307">Issue #5307</a> -  Fixed an issue to allow the Enter key to save data in the result grid text editor.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7289">Issue #7289</a> -  Move ‘About pgAdmin 4’ to app menu on macOS.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7655">Issue #7655</a> -  Fixed an issue where the query tool was crashing when an empty geometry was being rendered.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7837">Issue #7837</a> -  Fixed an issue where role properties were not loading.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7883">Issue #7883</a> -  Fix multiple issues related to debugger params dialog input.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7919">Issue #7919</a> -  Fixed an issue where the dock layout was not saved upon closing a tab.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7920">Issue #7920</a> -  Fixed an issue where the copy shortcut CTRL +C was not working in the Query Tool data grid.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7955">Issue #7955</a> -  Fixed an issue where Dashboard tab showing ‘Something went wrong’.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7957">Issue #7957</a> -  Fixed an issue where cursor selection is not visible in the PSQL tool.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7965">Issue #7965</a> -  Allow OAuth2 params OAUTH2_NAME, OAUTH2_DISPLAY_NAME, OAUTH2_ICON, OAUTH2_BUTTON_COLOR to be optional.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7988">Issue #7988</a> -  Add appropriate minimum width and height setting for desktop apps to avoid app accidentally going below visibility levels.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7993">Issue #7993</a> -  Fixed an issue where graphical explain keeps the node details open even after plan changed.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8007">Issue #8007</a> -  Fixed an issue in the debugger where function arguments of the character data type were being truncated.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8013">Issue #8013</a> -  Fix the issue where rows do not retain shading when scrolling.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8022">Issue #8022</a> -  Use PG17 as the default in the container.</div>
</div>
</div></blockquote>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 8.13</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 8.13</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_8_12.html" title="Version 8.12">next</a> |</li>
            <li class="right" ><a href="release_notes_8_14.html" title="Version 8.14">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
