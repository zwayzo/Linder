...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 5.0 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 4.30" href="release_notes_4_30.html" />
    <link rel="prev" title="Version 5.1" href="release_notes_5_1.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_4_30.html" title="Version 4.30"
             accesskey="N">next</a> |</li>
        <li class="right" >
          <a href="release_notes_5_1.html" title="Version 5.1"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 5.0</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-5-0">
<h1>Version 5.0<a class="headerlink" href="#version-5-0" title="Link to this heading">¶</a></h1>
<p>Release date: 2021-02-25</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin4 4.30.</p>
<section id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5091">Issue #5091</a> -  Make Statistics, Dependencies, Dependants tabs closable and the user can add them back using the ‘Add panel’ option.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5912">Issue #5912</a> -  Added support for Logical Replication.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5967">Issue #5967</a> -  Implemented runtime using NWjs to open pgAdmin4 in a standalone window instead of the system tray and web browser.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6148">Issue #6148</a> -  Added Quick Search functionality for menu items and help articles.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6153">Issue #6153</a> -  Added publication and subscription support in Schema Diff.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6170">Issue #6170</a> -  Ensure logs are not stored in the container, and only sent to the console.</div>
</div>
</section>
<section id="housekeeping">
<h2>Housekeeping<a class="headerlink" href="#housekeeping" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5017">Issue #5017</a> -  Use cheroot as the default production server for pgAdmin4.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6145">Issue #6145</a> -  Documentation of Logical Replication.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6195">Issue #6195</a> -  Documentation of runtime with NWjs.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6196">Issue #6196</a> -  Documentation of Quick Search support.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6207">Issue #6207</a> -  Updated the JS dependencies to the latest.</div>
</div>
</section>
<section id="bug-fixes">
<h2>Bug fixes<a class="headerlink" href="#bug-fixes" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5809">Issue #5809</a> -  Fixed an issue where the focus is not properly set on the filter text editor after closing the error dialog.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5871">Issue #5871</a> -  Ensure that username should be visible in the ‘Connect to Server’ popup when service and user name both specified.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6045">Issue #6045</a> -  Fixed autocomplete issue where it is not showing any suggestions if the schema name contains escape characters.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6087">Issue #6087</a> -  Fixed an issue where the dependencies tab showing multiple owners for the objects having shared dependencies.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6117">Issue #6117</a> -  Fixed an issue where the user is unable to update column-level privileges from the security tab.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6143">Issue #6143</a> -  Fixed an issue where shared server entries not getting deleted from SQLite database if the user gets deleted.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6157">Issue #6157</a> -  Fixed an issue where strike-through is not visible for rows selected for deletion after scrolling.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6163">Issue #6163</a> -  Fixed an issue where Zoom to fit button only works if the diagram is larger than the canvas.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6164">Issue #6164</a> -  Ensure that the diagram should not vanish entirely if zooming out too far in ERD.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6177">Issue #6177</a> -  Fixed an issue while downloading ERD images in Safari and Firefox.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6178">Issue #6178</a> -  Fixed an issue where the user unable to change the background color for a server.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6179">Issue #6179</a> -  Fixed an issue where Generate SQL displayed twice in the ERD tool.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6180">Issue #6180</a> -  Updated missing documentation for the ‘Download Image’ option in ERD.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6187">Issue #6187</a> -  Limit the upgrade check to run once per day.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6193">Issue #6193</a> -  Ensure that ERD throws a warning before closing unsaved changes if open in a new tab.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6197">Issue #6197</a> -  Fixed an issue where the ERD image is not properly downloaded.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6201">Issue #6201</a> -  Added SSL support for creating a subscription.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6208">Issue #6208</a> -  Fixed an issue where utility(Backup, Maintenance, …) jobs are failing when the log level is set to DEBUG.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6230">Issue #6230</a> -  Fixed an issue where the user is not able to create the subscription.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6250">Issue #6250</a> -  Ensure DEB/RPM packages depend on the same version of each other.</div>
</div>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 5.0</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 5.0</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_4_30.html" title="Version 4.30">next</a> |</li>
            <li class="right" ><a href="release_notes_5_1.html" title="Version 5.1">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
