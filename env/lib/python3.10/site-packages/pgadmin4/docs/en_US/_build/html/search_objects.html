...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Search objects &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="External database for pgAdmin user settings" href="external_database.html" />
    ...
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">Search objects</a></li> 
      </ul>
    </div>  
  ...
  <section id="search-objects">
<span id="id1"></span><h1><span class="target" id="index-0"></span>Search objects<a class="headerlink" href="#search-objects" title="Link to this heading">¶</a></h1>
<img alt="Search objects dialog" class="align-center" src="_images/search_objects.png" />
<p>With this dialog, you can search for almost any kind of objects in a
database.</p>
<p>You can access it by right clicking a database or any of its child nodes
and select “Search objects”. You can also access it by hitting the
shortcut (default ALT+SHIFT+S).</p>
<p>The minimum pattern length are 3 characters. The search performed is
...
%ab%, ab%c, %%%, etc.</p>
<p>The result is presented in the grid with object name, object type and
the object path in the <a class="reference internal" href="tree_control.html#tree-control"><span class="std std-ref">object explorer</span></a>. You can double
click on a result row to select the object in the
<a class="reference internal" href="tree_control.html#tree-control"><span class="std std-ref">object explorer</span></a>. If the object is greyed out, this means that you
have not enabled those object types in the <a class="reference internal" href="preferences.html#preferences"><span class="std std-ref">preferences</span></a>,
so you can’t double click on it. You can click on the ellipsis appended to
the function and procedure names to see their arguments.</p>
<p>You can filter based on a particular object type by selecting one from the
...
<a class="reference internal" href="preferences.html#preferences"><span class="std std-ref">preferences</span></a>.</p>
</section>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Search objects</a></li>
</ul>
</li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="external_database.html" title="External database for pgAdmin user settings">next</a> |</li>
            <li class="right" ><a href="keyboard_shortcuts.html" title="Keyboard Shortcuts">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
