...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 4.26 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 4.25" href="release_notes_4_25.html" />
    <link rel="prev" title="Version 4.27" href="release_notes_4_27.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_4_27.html" title="Version 4.27"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 4.26</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-4-26">
<h1>Version 4.26<a class="headerlink" href="#version-4-26" title="Link to this heading">¶</a></h1>
<p>Release date: 2020-09-17</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin4 4.25.</p>
<section id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/2042">Issue #2042</a> -  Added SQL Formatter support in Query Tool.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4059">Issue #4059</a> -  Added a new button to the query tool toolbar to open a new query tool window.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4979">Issue #4979</a> -  Added shared server support for admin users.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5772">Issue #5772</a> -  Warn the user when connecting to a server that is older than pgAdmin supports.</div>
</div>
</section>
<section id="housekeeping">
<h2>Housekeeping<a class="headerlink" href="#housekeeping" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5332">Issue #5332</a> -  Improve code coverage and API test cases for Columns and Constraints (Index, Foreign Key, Check, Exclusion).</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5344">Issue #5344</a> -  Improve code coverage and API test cases for Grant Wizard.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5774">Issue #5774</a> -  Improve code coverage and API test cases for Tables.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5792">Issue #5792</a> -  Added documentation for shared server support.</div>
</div>
</section>
<section id="bug-fixes">
<h2>Bug fixes<a class="headerlink" href="#bug-fixes" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4216">Issue #4216</a> -  Ensure that schema names starting with ‘pg’ should be visible in browser tree when standard_conforming_strings is set to off.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5426">Issue #5426</a> -  Adjusted the height of jobstep code block to use maximum space.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5652">Issue #5652</a> -  Modified the ‘Commit’ and ‘Rollback’ query tool button icons.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5722">Issue #5722</a> -  Ensure that the user should be able to drop the database even if it is connected.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5732">Issue #5732</a> -  Fixed some accessibility issues.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5734">Issue #5734</a> -  Update the description of GIN and GiST indexes in the documentation.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5746">Issue #5746</a> -  Fixed an issue where –load-server does not allow loading connections that use pg_services.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5748">Issue #5748</a> -  Fixed incorrect reverse engineering SQL for Foreign key when creating a table.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5751">Issue #5751</a> -  Enable the ‘Configure’ and ‘View log’ menu option when the server taking longer than usual time to start.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5754">Issue #5754</a> -  Fixed an issue where schema diff is not working when providing the options to Foreign Data Wrapper, Foreign Server, and User Mapping.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5764">Issue #5764</a> -  Fixed SQL for Row Level Security which is incorrectly generated.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5765">Issue #5765</a> -  Fixed an issue in the query tool when columns are having the same name as javascript object internal functions.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5766">Issue #5766</a> -  Fixed string indices must be integers issue for PostgreSQL &lt; 9.3.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5773">Issue #5773</a> -  Fixed an issue where the application ignores the fixed port configuration value.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5775">Issue #5775</a> -  Ensure that ‘setup-web.sh’ should work in Debian 10.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5779">Issue #5779</a> -  Remove illegal argument from trigger function in trigger DDL statement.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5794">Issue #5794</a> -  Fixed excessive CPU usage by stopping the indefinite growth of the graph dataset.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5815">Issue #5815</a> -  Fixed an issue where clicking on the ‘Generate script’ button shows a forever spinner due to pop up blocker.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5816">Issue #5816</a> -  Ensure that the ‘CREATE SCHEMA’ statement should be present in the generated script if the schema is not present in the target database.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5820">Issue #5820</a> -  Fixed an issue while refreshing Resource Group.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5833">Issue #5833</a> -  Fixed an issue where custom sequences are not visible when show system objects are set to false.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5834">Issue #5834</a> -  Ensure that the ‘Remove Server Group’ option is available in the context menu.</div>
</div>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 4.26</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.26</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_4_25.html" title="Version 4.25">next</a> |</li>
            <li class="right" ><a href="release_notes_4_27.html" title="Version 4.27">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
