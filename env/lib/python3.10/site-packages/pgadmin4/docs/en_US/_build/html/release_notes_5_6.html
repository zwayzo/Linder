...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 5.6 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 5.5" href="release_notes_5_5.html" />
    <link rel="prev" title="Version 5.7" href="release_notes_5_7.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">Version 5.6</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-5-6">
<h1>Version 5.6<a class="headerlink" href="#version-5-6" title="Link to this heading">¶</a></h1>
<p>Release date: 2021-08-12</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin4 5.5.</p>
<section id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4904">Issue #4904</a> -  Added support to copy SQL from main window to query tool.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5198">Issue #5198</a> -  Added support for formatted JSON viewer/editor when interacting with data in a JSON column.</div>
</div>
</section>
<section id="housekeeping">
<h2>Housekeeping<a class="headerlink" href="#housekeeping" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6622">Issue #6622</a> -  Rename the “Resize by data?” to “Columns sized by” and disabled the ‘Maximum column width’ button if ‘Columns sized by’ is set to ‘Column data’.</div>
</div>
</section>
<section id="bug-fixes">
<h2>Bug fixes<a class="headerlink" href="#bug-fixes" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6337">Issue #6337</a> -  Ensure that the login account should be locked after N number of attempts. N is configurable using the ‘MAX_LOGIN_ATTEMPTS’ parameter.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6369">Issue #6369</a> -  Fixed CSRF errors for stale sessions by increasing the session expiration time for desktop mode.</div>
...
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6574">Issue #6574</a> -  Fixed an issue where paste is not working through Right-Click option on PSQL.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6580">Issue #6580</a> -  Fixed TypeError ‘NoneType’ object is not sub scriptable.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6586">Issue #6586</a> -  Fixed incorrect tablespace options in the drop-down for move objects dialog.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6618">Issue #6618</a> -  Fixed an issue where the titles in query tabs are different.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6619">Issue #6619</a> -  Fixed incorrect binary path issue when the user deletes the binary path from the preferences.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6643">Issue #6643</a> -  Ensure that all the required options should be loaded when the Range data type is selected while creating a custom data type.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6650">Issue #6650</a> -  Fixed dashboard server activity issue when active_since parameter is None.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6664">Issue #6664</a> -  Fixed an issue where even if the user is locked, he can reset the password and can login into pgAdmin.</div>
</div>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 5.6</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 5.6</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_5_5.html" title="Version 5.5">next</a> |</li>
            <li class="right" ><a href="release_notes_5_7.html" title="Version 5.7">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
