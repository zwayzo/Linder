...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Sequence Dialog &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Subscription Dialog" href="subscription_dialog.html" />
    ...
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="subscription_dialog.html" title="Subscription Dialog"
        ...
        <li class="nav-item nav-item-this"><a href="">Sequence Dialog</a></li> 
      </ul>
    </div>  
  ...
  <section id="sequence-dialog">
<span id="id1"></span><h1><span class="target" id="index-0"></span>Sequence Dialog<a class="headerlink" href="#sequence-dialog" title="Link to this heading">¶</a></h1>
...
<ul class="simple">
<li><p>Use the <em>Current Value</em> field to specify the sequence object's current value.
The next nextval will return exactly the specified value, and sequence advancement
commences with the following nextval. <em>This field is only available in the edit mode</em>.</p></li>
...
<li><p>Move the switch next to <em>Cycled</em> to the <em>Yes</em> position to allow the sequence to wrap
...
<li><p>Move the switch next to <em>Unlogged?</em> to the <em>Yes</em> position to make the sequence Unlogged.
The default is <em>No</em>. This option is available only on PostgreSQL 15 and above.</p></li>
<li><p>The <em>OWNED BY</em> option causes the sequence to be associated with a specific
...
the same owner and be in the same schema as the sequence.</p></li>
</ul>
...
<p>Your entries in the <em>Sequence</em> dialog generate a SQL command (see an
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="subscription_dialog.html" title="Subscription Dialog">next</a> |</li>
            <li class="right" ><a href="schema_dialog.html" title="Schema Dialog">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
