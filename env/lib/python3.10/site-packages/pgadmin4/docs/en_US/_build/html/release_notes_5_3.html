...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 5.3 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 5.2" href="release_notes_5_2.html" />
    <link rel="prev" title="Version 5.4" href="release_notes_5_4.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_5_4.html" title="Version 5.4"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 5.3</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-5-3">
<h1>Version 5.3<a class="headerlink" href="#version-5-3" title="Link to this heading">¶</a></h1>
<p>Release date: 2021-05-20</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin4 5.2.</p>
<section id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5954">Issue #5954</a> -  Added support to set auto width of columns by content size in the data output window.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6158">Issue #6158</a> -  Added support to connect PostgreSQL servers via Kerberos authentication.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6397">Issue #6397</a> -  Added “IF NOT EXISTS” clause while creating tables and partition tables which is convenient while using the ERD tool.</div>
</div>
</section>
...
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4436">Issue #4436</a> -  Fixed an issue where drag and drop object is not correct in codemirror for properties dialog.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5477">Issue #5477</a> -  Added support for cache bust webpack chunk files.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5555">Issue #5555</a> -  Fixed an issue where data is displayed in the wrong order when executing the query repeatedly.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5776">Issue #5776</a> -  Ensure that while connecting to the server using SSPI login, it should not prompt for the password.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6329">Issue #6329</a> -  Fixed an issue where the wrong SQL is showing for the child partition tables.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6341">Issue #6341</a> -  Fixed an issue where CSV download quotes the numeric columns.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6355">Issue #6355</a> -  Ensure that pgAdmin should not allow opening external files that are dragged into it.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6377">Issue #6377</a> -  Fixed an issue where schema diff does not create DROP DEFAULT statement for columns.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6385">Issue #6385</a> -  Ensure that Backup and Restore should work on shared servers.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6392">Issue #6392</a> -  Fixed an issue where the filter ‘Include/Exclude By Selection’ not working for null values.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6399">Issue #6399</a> -  Ensure that the user should not be able to add duplicate panels.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6407">Issue #6407</a> -  Added support for the creation of Nested Table and Varying Array Type for Advanced Server.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6408">Issue #6408</a> -  Fixed ModuleNotFoundError when running setup.py from outside of the root.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6409">Issue #6409</a> -  Fixed an issue where the current debug line is not visible in the ‘Dark’ theme.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6413">Issue #6413</a> -  Fixed an issue where duplicate columns are visible in the browser tree, which is owned by two sequences.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6414">Issue #6414</a> -  Fixed an issue where the Help message not displaying correctly on Login/Group role.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6416">Issue #6416</a> -  Added comment column in the properties panel for View and Materialized View collection node.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6417">Issue #6417</a> -  Fixed an issue where query editor is not being closed if the user clicks on the ‘Don’t Save’ button.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6420">Issue #6420</a> -  Ensure that pgAdmin4 shut down completely on the Quit command.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6443">Issue #6443</a> -  Fixed an issue where file dialog showing incorrect files for the selected file types.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6444">Issue #6444</a> -  Fixed an issue where the user is not warned if Kerberos ticket expiration is less than 30 min while initiating a global backup.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6445">Issue #6445</a> -  Ensure that proper identification should be there when the server is connected using Kerberos or without Kerberos.</div>
</div>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 5.3</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 5.3</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_5_2.html" title="Version 5.2">next</a> |</li>
            <li class="right" ><a href="release_notes_5_4.html" title="Version 5.4">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
