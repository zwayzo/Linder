...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 7.5 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 7.4" href="release_notes_7_4.html" />
    <link rel="prev" title="Version 7.6" href="release_notes_7_6.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_7_4.html" title="Version 7.4"
             accesskey="N">next</a> |</li>
        <li class="right" >
          <a href="release_notes_7_6.html" title="Version 7.6"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 7.5</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-7-5">
<h1>Version 7.5<a class="headerlink" href="#version-7-5" title="Link to this heading">¶</a></h1>
<p>Release date: 2023-07-27</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin 4 v7.4.</p>
...
<p><strong>psql</strong>, <strong>pg_dump</strong>, <strong>pg_dumpall</strong>, <strong>pg_restore</strong>: 15.3</p>
</section>
<section id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Link to this heading">¶</a></h2>
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6369">Issue #6369</a> -  Added support to detach partitions using concurrently and finalize.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6374">Issue #6374</a> -  Added all supported index storage parameters while creating an index.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6416">Issue #6416</a> -  Added new/missing parameters to pg_dumpall (Backup Server).</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6417">Issue #6417</a> -  Added new/missing parameters to pg_dump (Backup Objects).</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6562">Issue #6562</a> -  Added new/missing parameters to pg_restore.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6295">Issue #6295</a> -  Remove Bootstrap and jQuery from authentication pages and rewrite them in ReactJS.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6323">Issue #6323</a> -  Enable cluster deployment with gp3 volume for AWS &amp; BigAnimal cloud providers.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6423">Issue #6423</a> -  Clarify the LICENSE file to indicate that it is the PostgreSQL Licence.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6532">Issue #6532</a> -  Remove unsupported PostgreSQL versions from the container.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6163">Issue #6163</a> -  Fix an issue where queries can’t complete execution.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6165">Issue #6165</a> -  Fixed an issue where Import Export not working when using pgpassfile.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6317">Issue #6317</a> -  Fix an issue where queries longer than 1 minute get stuck - Container 7.1</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6356">Issue #6356</a> -  Fix an issue where queries get stuck with auto-completion enabled.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6364">Issue #6364</a> -  Fixed Query Tool/ PSQL tool tab title not getting updated on database rename.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6406">Issue #6406</a> -  Ensure user gets proper error if incorrect credentials are entered while authenticating AWS.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6489">Issue #6489</a> -  Fix an issue where the edit server fails in desktop mode if the server password is not stored.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6499">Issue #6499</a> -  Ensure that Backup, Restore, and Maintenance should work properly when pgpass file is used.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6501">Issue #6501</a> -  Fix the query tool auto-complete issue on the server reconnection.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6502">Issue #6502</a> -  Fix the query tool restore connection issue.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6509">Issue #6509</a> -  Fix the reconnecton issue if the PostgreSQL server is restarted from the backend.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6514">Issue #6514</a> -  Fix the connection and stability issues since v7, possibly related to background schema changes.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6515">Issue #6515</a> -  Fixed an issue where the query tool is unable to execute a query on Postgres 10 and below versions.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6524">Issue #6524</a> -  Fix the lost connection error in v7.4.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6531">Issue #6531</a> -  Fixed an issue where pgAdmin failed to setup role with hyphens in name.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6537">Issue #6537</a> -  Fixed an issue where filters are not working and query history shows empty queries.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6544">Issue #6544</a> -  Fix an issue where adding a sub-folder inside a folder is not working as expected in File Manager.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6556">Issue #6556</a> -  Fix an error ‘list’ object has no attribute ‘strip’ while attempting to populate auto-complete manually the first time.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6558">Issue #6558</a> -  Fixed an issue where ERD Tool can’t load the saved pgerd file from Shared Storage.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6582">Issue #6582</a> -  Fix an issue where inserting more than 10 rows does not work correctly in View Data; only parts end up in the table.</div>
</div>
</div></blockquote>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 7.5</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 7.5</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_7_4.html" title="Version 7.4">next</a> |</li>
            <li class="right" ><a href="release_notes_7_6.html" title="Version 7.6">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
