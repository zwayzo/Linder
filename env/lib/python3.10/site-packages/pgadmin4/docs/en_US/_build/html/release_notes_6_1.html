...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 6.1 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 6.0" href="release_notes_6_0.html" />
    <link rel="prev" title="Version 6.2" href="release_notes_6_2.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_6_0.html" title="Version 6.0"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 6.1</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-6-1">
<h1>Version 6.1<a class="headerlink" href="#version-6-1" title="Link to this heading">¶</a></h1>
<p>Release date: 2021-10-21</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin4 6.0.</p>
<section id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4596">Issue #4596</a> -  Added support for indent guides in the browser tree.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6081">Issue #6081</a> -  Added support for advanced table fields like the foreign key, primary key in the ERD tool.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6241">Issue #6241</a> -  Added support to allow tables to be dragged to ERD Tool.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6529">Issue #6529</a> -  Added index creation when generating SQL in the ERD tool.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6657">Issue #6657</a> -  Added support for authentication via the webserver (REMOTE_USER).</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6794">Issue #6794</a> -  Added support to enable/disable rules.</div>
</div>
</section>
...
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6719">Issue #6719</a> -  Fixed OAuth2 integration redirect issue.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6754">Issue #6754</a> -  Ensure that query highlighting color in the query tool should be less intensive.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6776">Issue #6776</a> -  Changed the label ‘Inherits Tables?’ to ‘Is inherited?’ as it misleading in the properties panel.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6790">Issue #6790</a> -  Fixed an issue where the user is unable to create an index with concurrently keyword.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6797">Issue #6797</a> -  Remove an extra blank line at the start of the SQL for function, procedure, and trigger function.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6802">Issue #6802</a> -  Fixed the issue of editing triggers for advanced servers.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6828">Issue #6828</a> -  Fixed an issue where the tree is not scrolling to the object selected from the search result.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6858">Issue #6858</a> -  Fixed object delete issue from the properties tab for the collection nodes.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6876">Issue #6876</a> -  Ensure that the Dashboard should get updated after connecting to the server.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6881">Issue #6881</a> -  Fixed an issue where the browser tree doesn’t show all contents on changing resolution.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6882">Issue #6882</a> -  Ensure that columns should be displayed in the order of creation instead of alphabetical order in the browser tree.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6890">Issue #6890</a> -  Fixed background colour issue in the browser tree.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6891">Issue #6891</a> -  Added support for composite foreign keys in the ERD tool.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6900">Issue #6900</a> -  Fixed an issue where exclusion constraint cannot be created from table dialog if the access method name is changed once.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6905">Issue #6905</a> -  Fixed an issue where the users are unable to load the databases behind an HTTP reverse proxy.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6908">Issue #6908</a> -  Fixed an issue where each click to refresh the collection node, the number of objects decreasing by tens or more.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6912">Issue #6912</a> -  Fixed browser tree sort order regression issue.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6915">Issue #6915</a> -  Fixed an issue where the blank string is stored instead of NULL in the server table of SQLite database.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6928">Issue #6928</a> -  Ensure that the master password should be prompt when MASTER_PASSWORD_REQUIRED is set to True and AUTHENTICATION_SOURCES is webserver.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6929">Issue #6929</a> -  Ensure that only the table node should be allowed to drop on the ERD tool.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6930">Issue #6930</a> -  Fixed an issue where the existing server group is disappeared on rename it.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6935">Issue #6935</a> -  Fixed an issue where the wrong SQL is generated when deleting and renaming table columns together.</div>
</div>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 6.1</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 6.1</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_6_0.html" title="Version 6.0">next</a> |</li>
            <li class="right" ><a href="release_notes_6_2.html" title="Version 6.2">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
