...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>View/Edit Data &#8212; pgAdmin 4 9.11 documentation</title>
...
<p>A built-in JSON editor is provided for <em>JSON/JSONB Data</em>. Double-clicking on a JSON/JSONB
...
Allows formatting and compacting JSON data as well.</p>
...
<td><p>Code, Preview, Tree, Form</p></td>
</tr>
<tr class="row-odd"><td><p><em>Redo</em></p></td>
<td><p>Click to <em>Redo</em> to repeat last action performed on data.</p></td>
<td><p>Code, Preview, Tree, Form</p></td>
</tr>
<tr class="row-even"><td><p><em>Mode</em></p></td>
<td><p>Click the <em>Mode</em> dropdown to change the display mode of the editor. Different modes
available are Code, Preview, Tree, and Form.</p></td>
<td><p>Code, Tree, Form, Preview</p></td>
</tr>
<tr class="row-odd"><td><p><em>Expand All</em></p></td>
<td><p>Click <em>Expand All</em> to expand JSON data.</p></td>
<td><p>Tree, Form</p></td>
</tr>
<tr class="row-even"><td><p><em>Collapse All</em></p></td>
<td><p>Click <em>Collapse All</em> to collapse JSON data.</p></td>
<td><p>Tree, Form</p></td>
</tr>
...
<li><p>Use the drop-down <em>NULLs</em> to select the NULL values order for the column.</p></li>
</ul>
...
<p>You can disable the dialog by selecting the “Don’t Ask again” checkbox. If you wish to resume the confirmation dialog, you can do it from “Preferences -&gt; Query Tool -&gt; Editor -&gt; Show View/Edit Data Promotion Warning?”</p>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="viewdata_filter.html" title="View/Edit Data Filter">next</a> |</li>
            <li class="right" ><a href="query_tool_toolbar.html" title="Query Tool Toolbar">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
