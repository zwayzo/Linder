...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Backup Server Dialog &#8212; pgAdmin 4 9.11 documentation</title>
...
<li><p>Move the switch next to <em>Role passwords</em> to the <em>Yes</em> position to exclude
...
<li><p>Move the switch next to <em>Toast compressions</em> to the <em>Yes</em> position to exclude
...
<li><p>Use the <em>Lock wait timeout</em> field to specify a timeout rather than waiting
indefinitely to acquire shared table locks at the beginning of the dump.
If unable to lock a table within the specified timeout, the operation will fail.</p></li>
</ul>
</div></blockquote>
</li>
</ul>
...
<p>pgAdmin will run the backup process in the background. You can view all the background
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="restore_dialog.html" title="Restore Dialog">next</a> |</li>
            <li class="right" ><a href="backup_globals_dialog.html" title="Backup Globals Dialog">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
