...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 6.6 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 6.5" href="release_notes_6_5.html" />
    <link rel="prev" title="Version 6.7" href="release_notes_6_7.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_6_5.html" title="Version 6.5"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 6.6</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-6-6">
<h1>Version 6.6<a class="headerlink" href="#version-6-6" title="Link to this heading">¶</a></h1>
<p>Release date: 2022-03-10</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin4 6.5.</p>
<section id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7177">Issue #7177</a> -  Added capability to deploy PostgreSQL servers on Amazon RDS.</div>
</div>
</section>
<section id="housekeeping">
<h2>Housekeeping<a class="headerlink" href="#housekeeping" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7180">Issue #7180</a> -  Rename the menu ‘Disconnect Database’ to ‘Disconnect from database’.</div>
</div>
</section>
<section id="bug-fixes">
<h2>Bug fixes<a class="headerlink" href="#bug-fixes" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6956">Issue #6956</a> -  Fixed a schema diff issue in which user mappings were not compared correctly.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6991">Issue #6991</a> -  Fixed an issue where pgadmin cannot connect to LDAP when STARTTLS is required before bind.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6999">Issue #6999</a> -  Fixed an issue where a warning is flashed every time for an email address when authentication sources are internal and ldap.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7105">Issue #7105</a> -  Fixed an issue where the parent partition table was not displayed during autocomplete.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7124">Issue #7124</a> -  Fixed the schema diff issue where tables have different column positions and a column has a default value.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7152">Issue #7152</a> -  Added comments column for the functions collection node.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7172">Issue #7172</a> -  Allow users to scroll and enter input when there is a validation error.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7173">Issue #7173</a> -  Fixed an issue where the User Management dialog is not opening.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7181">Issue #7181</a> -  Ensure that the user should be able to add new server with unix socket connection.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7186">Issue #7186</a> -  Fixes an issue where the connect server/database menu was not updated correctly.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7202">Issue #7202</a> -  Ensure that Flask-Security-Too is using the latest version.</div>
</div>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 6.6</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 6.6</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_6_5.html" title="Version 6.5">next</a> |</li>
            <li class="right" ><a href="release_notes_6_7.html" title="Version 6.7">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
