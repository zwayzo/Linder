...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Unique Constraint Dialog &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">Unique Constraint Dialog</a></li> 
      </ul>
    </div>  
  ...
  <section id="unique-constraint-dialog">
<span id="id1"></span><h1><span class="target" id="index-0"></span>Unique Constraint Dialog<a class="headerlink" href="#unique-constraint-dialog" title="Link to this heading">¶</a></h1>
...
is <em>No</em>.</p></li>
<li><p>Move the <em>NULLs not distinct?</em> switch to the <em>Yes</em> position to treat null values as not distinct. The default is
<em>No</em>. This option is available only on PostgreSQL 15 and above.</p></li>
</ul>
...
<p>The example shown demonstrates creating a unique constraint named <em>jobhist_unique</em> on
the <em>empno</em> column of the <em>jobhist</em> table.</p>
<ul class="simple">
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="management_basics.html" title="Management Basics">next</a> |</li>
            <li class="right" ><a href="trigger_dialog.html" title="Trigger Dialog">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
