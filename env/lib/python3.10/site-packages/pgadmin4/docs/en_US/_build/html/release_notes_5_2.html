...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 5.2 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 5.1" href="release_notes_5_1.html" />
    <link rel="prev" title="Version 5.3" href="release_notes_5_3.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_5_3.html" title="Version 5.3"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 5.2</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-5-2">
<h1>Version 5.2<a class="headerlink" href="#version-5-2" title="Link to this heading">¶</a></h1>
<p>Release date: 2021-04-22</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin4 5.1.</p>
...
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5319">Issue #5319</a> -  Improve code coverage and API test cases for Server module.</div>
</div>
</section>
<section id="bug-fixes">
<h2>Bug fixes<a class="headerlink" href="#bug-fixes" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4001">Issue #4001</a> -  Updated docs and screenshots to cover the Notifications tab on the Query Tool.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5519">Issue #5519</a> -  Ensure that the query tool tab should be closed after server disconnection when auto-commit/auto-rollback is set to false.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5908">Issue #5908</a> -  Fixed an issue where shortcut keys are not working with manage macro.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6076">Issue #6076</a> -  Fixed an issue where correct error not thrown while importing servers and JSON file has incorrect/insufficient keys.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6082">Issue #6082</a> -  Ensure that the user should not be to change the connection when a long query is running.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6107">Issue #6107</a> -  Fixed flickering issue of the input box on check constraints.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6161">Issue #6161</a> -  Fixed an issue where the cursor shifts its focus to the wrong window for all the query tool related model dialogs.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6220">Issue #6220</a> -  Corrected the syntax for ‘CREATE TRIGGER’, use ‘EXECUTE FUNCTION’ instead of ‘EXECUTE PROCEDURE’ from v11 onwards.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6274">Issue #6274</a> -  Ensure that the strings in the LDAP auth module are translatable.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6293">Issue #6293</a> -  Fixed an issue where the procedure creation is failed when providing the Volatility option.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6306">Issue #6306</a> -  Fixed an issue while selecting the row which was deleted just before the selection operation.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6325">Issue #6325</a> -  Ensure that the file format for the storage manager should be ‘All files’ and for other dialogs, it should remember the last selected format.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6327">Issue #6327</a> -  Ensure that while comparing domains check function dependencies should be considered in schema diff.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6333">Issue #6333</a> -  Fixed sizing issue of help dialog for Query Tool and ERD Tool when open in the new browser tab.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6334">Issue #6334</a> -  Fixed SQL panel black screen issue when detaching it in runtime.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6338">Issue #6338</a> -  Added missing dependency ‘xdg-utils’ for the desktop packages in RPM and Debian.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6344">Issue #6344</a> -  Fixed cannot unpack non-iterable response object error when selecting any partition.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6356">Issue #6356</a> -  Mark the Apache HTTPD config file as such in the web DEB and RPM packages.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6367">Issue #6367</a> -  Fixed an issue where the Save button is enabled by default when open the table’s properties dialog on PG 9.5.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6375">Issue #6375</a> -  Fixed an issue where users are unable to see data of the partitions using the View/Edit data option.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6376">Issue #6376</a> -  Fixed an issue where a connection warning should be displayed on the user clicks on explain or explain analyze and the database server is disconnected from the browser tree.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6379">Issue #6379</a> -  Fixed an issue where foreign data wrapper properties are not visible if the host option contains two host addresses.</div>
</div>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 5.2</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 5.2</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_5_1.html" title="Version 5.1">next</a> |</li>
            <li class="right" ><a href="release_notes_5_3.html" title="Version 5.3">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
