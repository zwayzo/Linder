...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 8.0 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 7.8" href="release_notes_7_8.html" />
    <link rel="prev" title="Version 8.1" href="release_notes_8_1.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_7_8.html" title="Version 7.8"
             accesskey="N">next</a> |</li>
        <li class="right" >
          <a href="release_notes_8_1.html" title="Version 8.1"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 8.0</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-8-0">
<h1>Version 8.0<a class="headerlink" href="#version-8-0" title="Link to this heading">¶</a></h1>
<p>Release date: 2023-11-23</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin 4 v7.8.</p>
...
<p><strong>PostgreSQL</strong>: 12, 13, 14, 15, and 16</p>
<p><strong>EDB Advanced Server</strong>: 12, 13, 14, 15, and 16</p>
</section>
...
<p><strong>psql</strong>, <strong>pg_dump</strong>, <strong>pg_dumpall</strong>, <strong>pg_restore</strong>: 16.0</p>
</section>
<section id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Link to this heading">¶</a></h2>
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/2821">Issue #2821</a> -  Have close buttons on individual panel tabs instead of common.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/4733">Issue #4733</a> -  Allow closing all the tabs, including SQL and Properties.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5394">Issue #5394</a> -  Changes in the context menu on panel tabs - Add close, close all and close others menu items.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6441">Issue #6441</a> -  Update app bundle built to use notarytool instead of altool.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6479">Issue #6479</a> -  Replace the current layout library wcDocker with ReactJS based rc-dock.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6850">Issue #6850</a> -  Upgrade Flask, Werkzeug and other modules depends on the latest version of Flask.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/2986">Issue #2986</a> -  Fix an issue where the scroll position of panels was not remembered on Firefox.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5770">Issue #5770</a> -  Add DROP SQL for foreign keys in SQL generated by ERD when using WITH DROP option.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5807">Issue #5807</a> -  Fixed an issue where psql was not taking the role used to connect in server properties.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6017">Issue #6017</a> -  Fixed an issue where Geometry Viewer renders geometry incorrectly after trying to view 3D or non-4326 SRID geometry.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6459">Issue #6459</a> -  Fix the sorting of size on the statistics panel.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6487">Issue #6487</a> -  Fixed restoration of query tool database connection after dropping and re-creating the database with the same name.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6602">Issue #6602</a> -  Fix an issue where the default server-group is being deleted if the load-server json file contains no servers.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6720">Issue #6720</a> -  Fix an issue of the incorrect format (no indent) of SQL stored functions/procedures.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6769">Issue #6769</a> -  Server config information in the about dialog should be only visible to admin users.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6784">Issue #6784</a> -  Fixed an issue where Schema Diff does not work when the user language is set to any language other than English in Preferences.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6817">Issue #6817</a> -  Fixed the query generated when creating subscription where copy_data parameter was missing.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6820">Issue #6820</a> -  Ensure backup/restore/maintenance works with invalid pgpass file parameter.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6835">Issue #6835</a> -  Fix an issue where OAUTH_ADDITIONAL_CLAIMS does not recognise AzureAD with &gt; 150 groups.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6840">Issue #6840</a> -  Fixed circular import error occurring while deploying cloud PostgreSQL instance from pgAdmin.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6874">Issue #6874</a> -  Fix an issue where the browser window stuck on spinning with an Oauth user without email.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6875">Issue #6875</a> -  Fix an issue where import/export data is not working for shared servers.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6877">Issue #6877</a> -  Remove the max length of 255 from password exec command in server configuration dialog.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6884">Issue #6884</a> -  Remove gettext from empty strings in the title of the storage graph.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6902">Issue #6902</a> -  Fixed an issue where the change server password is not working in desktop mode.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6904">Issue #6904</a> -  Fix a crash issue occurring when debugging a function with arguments when using pgAdmin with external config database.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6920">Issue #6920</a> -  Fix an issue in ERD tool where SQL generated is missing columns for the table.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6934">Issue #6934</a> -  Clear the password field in the config database on clear saved server password.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6962">Issue #6962</a> -  Fixed an issue where the data type of the array type was not visible for the column in the Foreign Table dialog.</div>
</div>
</div></blockquote>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 8.0</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 8.0</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_7_8.html" title="Version 7.8">next</a> |</li>
            <li class="right" ><a href="release_notes_8_1.html" title="Version 8.1">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
