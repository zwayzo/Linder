...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>The config.py File &#8212; pgAdmin 4 9.11 documentation</title>
...
<span class="kn">from</span><span class="w"> </span><span class="nn">pgadmin.utils</span><span class="w"> </span><span class="kn">import</span> <span class="n">env</span><span class="p">,</span> <span class="n">IS_WIN</span><span class="p">,</span> <span class="n">fs_short_path</span>
<span class="kn">from</span><span class="w"> </span><span class="nn">version</span><span class="w"> </span><span class="kn">import</span> <span class="n">APP_VERSION</span><span class="p">,</span> <span class="n">APP_RELEASE</span><span class="p">,</span> <span class="n">APP_REVISION</span><span class="p">,</span> <span class="n">APP_SUFFIX</span><span class="p">,</span> \
    <span class="n">APP_VERSION_INT</span>
<span class="kn">from</span><span class="w"> </span><span class="nn">branding</span><span class="w"> </span><span class="kn">import</span> <span class="n">APP_NAME</span><span class="p">,</span> <span class="n">APP_ICON</span><span class="p">,</span> <span class="n">APP_COPYRIGHT</span><span class="p">,</span> <span class="n">APP_PATH</span><span class="p">,</span> \
...
<span class="n">LANGUAGES</span> <span class="o">=</span> <span class="p">{</span>
    ...
    <span class="s1">&#39;zh_Hans_CN&#39;</span><span class="p">:</span> <span class="s1">&#39;Chinese (Simplified)&#39;</span><span class="p">,</span>
    <span class="s1">&#39;zh_Hant_TW&#39;</span><span class="p">:</span> <span class="s1">&#39;Chinese (Traditional)&#39;</span><span class="p">,</span>
    ...
    <span class="s1">&#39;sv&#39;</span><span class="p">:</span> <span class="s1">&#39;Swedish&#39;</span>
<span class="p">}</span>
...
<span class="c1"># The Cross-Origin-Opener-Policy allows a website to control whether</span>
<span class="c1"># a new top-level document, opened using Window.open() or by navigating</span>
<span class="c1"># to a new page, is opened in the same browsing context group (BCG)</span>
<span class="c1"># or in a new browsing context group.</span>
<span class="c1"># Set to &#39;unsafe-none&#39;, &#39;same-origin-allow-popups&#39;, &#39;same-origin&#39;,</span>
<span class="c1"># or &#39;noopener-allow-popups&#39;</span>

<span class="n">CROSS_ORIGIN_OPENER_POLICY</span> <span class="o">=</span> <span class="s2">&quot;same-origin&quot;</span>
...
<span class="c1"># Session digest method</span>
<span class="n">SESSION_DIGEST_METHOD</span> <span class="o">=</span> <span class="s1">&#39;hashlib.sha1&#39;</span>
...
<span class="n">ALLOW_SPECIAL_EMAIL_DOMAINS</span> <span class="o">=</span> <span class="p">[]</span>
<span class="c1"># Disables global deliverable check while email validation</span>
<span class="n">GLOBALLY_DELIVERABLE</span> <span class="o">=</span> <span class="kc">True</span>
<span class="c1">##########################################################################</span>
...
<span class="n">DEFAULT_BINARY_PATHS</span> <span class="o">=</span> <span class="p">{</span>
    ...
    <span class="s2">&quot;pg-17&quot;</span><span class="p">:</span> <span class="s2">&quot;&quot;</span><span class="p">,</span>
    <span class="s2">&quot;pg-18&quot;</span><span class="p">:</span> <span class="s2">&quot;&quot;</span><span class="p">,</span>
    ...
    <span class="s2">&quot;ppas-16&quot;</span><span class="p">:</span> <span class="s2">&quot;&quot;</span><span class="p">,</span>
    <span class="s2">&quot;ppas-17&quot;</span><span class="p">:</span> <span class="s2">&quot;&quot;</span><span class="p">,</span>
    <span class="s2">&quot;ppas-18&quot;</span><span class="p">:</span> <span class="s2">&quot;&quot;</span>
<span class="p">}</span>
...
<span class="c1">##########################################################################</span>
<span class="c1"># Number of records to fetch in one page in query tool when query result</span>
<span class="c1"># set is large and is divided in multiple pages</span>
<span class="c1">##########################################################################</span>
<span class="n">DATA_RESULT_ROWS_PER_PAGE</span> <span class="o">=</span> <span class="mi">1000</span>
...
<span class="c1">##########################################################################</span>
<span class="c1"># Allow to save master password which is used to encrypt/decrypt saved</span>
<span class="c1"># passwords in the os level secret like Keychain, password store etc.</span>
<span class="c1"># Disabling this will require user to enter master password</span>
<span class="c1"># if MASTER_PASSWORD_REQUIRED is set to True. Note: this is applicable only</span>
<span class="c1"># in case of Desktop mode.</span>
<span class="c1">##########################################################################</span>
<span class="n">USE_OS_SECRET_STORAGE</span> <span class="o">=</span> <span class="kc">True</span>
<span class="c1">##########################################################################</span>
...
<span class="c1"># TLS/SSL certificate Validation (True/False),</span>
<span class="c1"># Make it false if certificate validation is not required.</span>
<span class="n">LDAP_CERT_VALIDATE</span> <span class="o">=</span> <span class="kc">True</span>
<span class="c1">##########################################################################</span>
...
<span class="c1">#############################################################################</span>
<span class="c1"># Maximum number of Tags allowed on a server node</span>
<span class="c1">##############################################################################</span>
<span class="n">MAX_SERVER_TAGS_ALLOWED</span> <span class="o">=</span> <span class="mi">5</span>

<span class="c1">#############################################################################</span>
<span class="c1"># Number of records to fetch in one batch for server logs.</span>
<span class="c1">##############################################################################</span>

<span class="n">ON_DEMAND_LOG_COUNT</span> <span class="o">=</span> <span class="mi">10000</span>

<span class="c1">#############################################################################</span>
<span class="c1"># Patch the default config with custom config and other manipulations</span>
<span class="c1">#############################################################################</span>
<span class="kn">from</span><span class="w"> </span><span class="nn">pgadmin.evaluate_config</span><span class="w"> </span><span class="kn">import</span> <span class="n">evaluate_and_patch_config</span>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="desktop_deployment.html" title="Desktop Deployment">next</a> |</li>
            <li class="right" ><a href="deployment.html" title="Deployment">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
