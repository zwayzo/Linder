...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 4.25 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 4.24" href="release_notes_4_24.html" />
    <link rel="prev" title="Version 4.26" href="release_notes_4_26.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_4_24.html" title="Version 4.24"
             accesskey="N">next</a> |</li>
        <li class="right" >
          <a href="release_notes_4_26.html" title="Version 4.26"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 4.25</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-4-25">
<h1>Version 4.25<a class="headerlink" href="#version-4-25" title="Link to this heading">¶</a></h1>
<p>Release date: 2020-08-20</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin4 4.24.</p>
<section id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3904">Issue #3904</a> -  Replace charting library Flotr2 with ChartJS using React.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5126">Issue #5126</a> -  Modified schema diff tool to compare two databases instead of two schemas.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5610">Issue #5610</a> -  Add a –yes command line option to setup-web.sh to allow non-interactive use.</div>
</div>
</section>
<section id="housekeeping">
<h2>Housekeeping<a class="headerlink" href="#housekeeping" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5324">Issue #5324</a> -  Improve code coverage and API test cases for Foreign Servers and User Mappings.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5327">Issue #5327</a> -  Improve code coverage and API test cases for Schemas.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5336">Issue #5336</a> -  Improve code coverage and API test cases for Types.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5700">Issue #5700</a> -  Remove old Python 2 compatibility code.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5731">Issue #5731</a> -  Upgrade font awesome from v4 to v5.</div>
</div>
</section>
<section id="bug-fixes">
<h2>Bug fixes<a class="headerlink" href="#bug-fixes" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3767">Issue #3767</a> -  Ensure that the original file format should be retained when saving the same file in SQL editor.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3791">Issue #3791</a> -  Added missing comments in reverse engineering SQL for each column of a View.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4123">Issue #4123</a> -  Fixed an issue where debugger doesn’t work if the search path is set other than ‘public’.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4361">Issue #4361</a> -  Fixed ssh tunnel hang issue when the user tries to disconnect the server.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4387">Issue #4387</a> -  Fixed an issue where the user is not able to insert the data if the table and columns name contains special characters.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4810">Issue #4810</a> -  Fixed an issue where the user is not able to save the new row if the table is empty.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5429">Issue #5429</a> -  Ensure that the Dictionaries drop-down shows all the dictionaries in the FTS configuration dialog.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5490">Issue #5490</a> -  Make the runtime configuration dialog non-modal.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5526">Issue #5526</a> -  Fixed an issue where copying and pasting a cell with multiple line data will result in multiple rows.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5567">Issue #5567</a> -  Fixed an issue where conversion of bytea to the binary string results in an error.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5604">Issue #5604</a> -  Fixed an issue where the entire logs is in red text when the user runs backup and restore.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5632">Issue #5632</a> -  Ensure that the user will be able to modify the start value of the Identity column.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5646">Issue #5646</a> -  Ensure that RLS Policy node should be searchable using search object.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5664">Issue #5664</a> -  Fixed an issue where ‘ALTER VIEW’ statement is missing when the user sets the default value of a column for View.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5670">Issue #5670</a> -  Fixed an issue where the error message does not have a close button on utility dialogs.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5689">Issue #5689</a> -  Added the ‘ORDER BY’ clause for the privileges type to fix schema diff issue.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5708">Issue #5708</a> -  Correct TLS certificate filename in the container deployment docs.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5710">Issue #5710</a> -  Fixed an issue when comparing the table with a trigger throwing error in schema diff.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5713">Issue #5713</a> -  Corrected DROP SQL syntax for catalog.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5716">Issue #5716</a> -  Fixed an issue where ajax call continues to fire even after disconnecting the database server.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5724">Issue #5724</a> -  Clarify some of the differences when running in server mode in the docs.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5730">Issue #5730</a> -  Resolve schema diff dependencies by selecting the appropriate node automatically and maintain the order in the generated script.</div>
</div>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 4.25</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.25</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_4_24.html" title="Version 4.24">next</a> |</li>
            <li class="right" ><a href="release_notes_4_26.html" title="Version 4.26">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
