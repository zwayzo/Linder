...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Event Trigger Dialog &#8212; pgAdmin 4 9.11 documentation</title>
...
<p>Your entries in the <em>Event Trigger</em> dialog generate a SQL command.
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="extension_dialog.html" title="Extension Dialog">next</a> |</li>
            <li class="right" ><a href="domain_constraint_dialog.html" title="Domain Constraints Dialog">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
