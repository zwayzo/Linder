...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Clear Saved Passwords &#8212; pgAdmin 4 9.11 documentation</title>
...
database server.</p>
<img alt="Clear saved password" class="align-center" src="_images/clear_saved_password.png" />
...
<img alt="Clear SSH tunnel password" class="align-center" src="_images/clear_tunnel_password.png" />
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="cloud_deployment.html" title="PostgreSQL Cloud Deployment">next</a> |</li>
            <li class="right" ><a href="server_dialog.html" title="Server Dialog">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
