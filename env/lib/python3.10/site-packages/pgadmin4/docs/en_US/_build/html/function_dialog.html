...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Function Dialog &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">Function Dialog</a></li> 
      </ul>
    </div>  
  ...
  <section id="function-dialog">
<span id="id1"></span><h1><span class="target" id="index-0"></span>Function Dialog<a class="headerlink" href="#function-dialog" title="Link to this heading">¶</a></h1>
...
following dialog tabs: <em>General</em>, <em>Definition</em>, <em>Code</em>, <em>Options</em>,
...
<ul class="simple">
<li><p>Move the <em>Custom return type?</em> switch to provide a user defined return type.</p></li>
<li><p>Use the drop-down listbox next to <em>Return type</em> to select the data type
returned by the function, if any. If <em>Custom return type?</em> is enabled this field
will change to an input text field.</p></li>
<li><p>Use the drop-down listbox next to <em>Language</em> to select the implementation
language. The default is <em>sql</em>.</p></li>
<li><p>Use the drop-down listbox next to <em>Depends on extensions</em> to select the extension that this function
depends on (for example, plpgsql). If set, dropping the extension will automatically drop the
function as well.</p></li>
<li><p>Use the fields in the <em>Arguments</em> to define an argument. Click the <em>Add</em>
...
<img alt="Function dialog code tab" class="align-center" src="_images/function_code.png" />
<ul class="simple">
...
<li><p>Use the <em>Support function</em> field to specify a planner support function to
use for the function.</p></li>
</ul>
...
<p>Your entries in the <em>Function</em> dialog generate a SQL command (see an
...
<p>The example demonstrates creating a <em>plpgsql</em> function named <em>hire_salesmen</em>. The
function has three columns (p_ename, p_sal and p_comm).</p>
<ul class="simple">
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="language_dialog.html" title="Language Dialog">next</a> |</li>
            <li class="right" ><a href="fts_template_dialog.html" title="FTS Template Dialog">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
