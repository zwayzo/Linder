...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 8.2 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 8.1" href="release_notes_8_1.html" />
    <link rel="prev" title="Version 8.3" href="release_notes_8_3.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_8_3.html" title="Version 8.3"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 8.2</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-8-2">
<h1>Version 8.2<a class="headerlink" href="#version-8-2" title="Link to this heading">¶</a></h1>
<p>Release date: 2024-01-11</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin 4 v8.1.</p>
...
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/2483">Issue #2483</a> -  Administer pgAdmin Users and Preferences Using the Command Line Interface (CLI).</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5908">Issue #5908</a> -  Allow users to convert View/Edit table into a Query tool to enable editing the SQL generated.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6085">Issue #6085</a> -  Added copy server support, allowing the duplication of existing servers with the option to make certain modifications.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7016">Issue #7016</a> -  Added keep-alive support for SSH sessions when connecting to a PostgreSQL server via an SSH tunnel.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6926">Issue #6926</a> -  Ensure that eventlet’s subprocess should be used following the resolution of an issue with Python 3.12 by eventlet.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6193">Issue #6193</a> -  Fixed an issue where query tool title did not change after “Save As” until any new change is made.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6781">Issue #6781</a> -  Fixed an issue where export servers was not adding extension if not specified.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6815">Issue #6815</a> -  Fixed an issue where pgAdmin imports servers to the wrong accounts for the external authentication.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7002">Issue #7002</a> -  Fixed an issue where an error occurred in the SQL tab when using an extended index(pgroonga).</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7041">Issue #7041</a> -  Fixed an issue where changes done to a node using edit dialog are not reflecting on the properties tab if the properties tab is active.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7059">Issue #7059</a> -  Fixed an issue where DB Restrictions were not visible on the server dialog.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7061">Issue #7061</a> -  Ensure that the ‘Dbo’ schema is displayed as a regular schema rather than a system catalog schema.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7062">Issue #7062</a> -  Introduce LDAP configuration parameter LDAP_IGNORE_MALFORMED_SCHEMA to ignore fetching schema from the LDAP server.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7064">Issue #7064</a> -  Fixed an error-‘amname’ when generating ERD for database containing partition tables.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7066">Issue #7066</a> -  Fixed an issue where object explorer last tree state was not saving.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7070">Issue #7070</a> -  Fixed an issue where pgAgent job schedule dialog is not opening for edit.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7078">Issue #7078</a> -  Fixed an issue where user is not able to cancel or terminate active queries from dashboard.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7082">Issue #7082</a> -  Fixed browser autocomplete related issues on pgAdmin authentication related pages.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7091">Issue #7091</a> -  Fixed an issue where auto commit/rollback setting not persisting across query tool connection change.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7104">Issue #7104</a> -  Fixed an issue where Schema Diff not generating difference for missing columns.</div>
</div>
</div></blockquote>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 8.2</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 8.2</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_8_1.html" title="Version 8.1">next</a> |</li>
            <li class="right" ><a href="release_notes_8_3.html" title="Version 8.3">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
