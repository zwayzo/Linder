...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Connection Error &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="import_export_servers.html" title="Import/Export Servers">next</a> |</li>
            <li class="right" ><a href="connect_to_server.html" title="Connect to Server">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
