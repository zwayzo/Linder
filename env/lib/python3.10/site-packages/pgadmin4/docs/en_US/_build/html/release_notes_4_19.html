...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 4.19 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 4.18" href="release_notes_4_18.html" />
    <link rel="prev" title="Version 4.20" href="release_notes_4_20.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">Version 4.19</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-4-19">
<h1>Version 4.19<a class="headerlink" href="#version-4-19" title="Link to this heading">¶</a></h1>
<p>Release date: 2020-03-05</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin4 4.18.</p>
<section id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5154">Issue #5154</a> -  Added accessibility support in AlertifyJS.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5170">Issue #5170</a> -  Added Czech language support.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5179">Issue #5179</a> -  Added Python 3.8 support.</div>
</div>
</section>
<section id="housekeeping">
<h2>Housekeeping<a class="headerlink" href="#housekeeping" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5088">Issue #5088</a> -  Improve code coverage and API test cases for the Event Trigger module.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5133">Issue #5133</a> -  Improvements in the UI for both default and dark themes.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5176">Issue #5176</a> -  Enhance logging by tracking stdout and stderr of subprocess when log level set to DEBUG.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5185">Issue #5185</a> -  Added option to override the class name of a label tag for select2 control.</div>
</div>
</section>
<section id="bug-fixes">
<h2>Bug fixes<a class="headerlink" href="#bug-fixes" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4955">Issue #4955</a> -  Changed the color of selected and hovered item for Select2 dropdown.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4996">Issue #4996</a> -  Improve the style of the highlighted code after query execution for Dark mode.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5058">Issue #5058</a> -  Ensure that AlertifyJS should not be visible as a title for alert dialog.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5077">Issue #5077</a> -  Changed background pattern for geometry viewer to use #fff for all themes.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5101">Issue #5101</a> -  Fix an issue where debugger not showing all arguments anymore after hitting SQL error while debugging.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5107">Issue #5107</a> -  Set proper focus on tab navigation for file manager dialog.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5115">Issue #5115</a> -  Fix an issue where command and statements were parsed incorrectly for Rules.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5142">Issue #5142</a> -  Ensure that all the transactions should be canceled before closing the connections when a server is disconnected using pgAdmin.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5184">Issue #5184</a> -  Fixed Firefox monospaced issue by updating the font to the latest version.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5214">Issue #5214</a> -  Update Flask-SQLAlchemy and SQLAlchemy package which is not working on Windows with Python 3.8.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5215">Issue #5215</a> -  Fix syntax error when changing the event type for the existing rule.</div>
</div>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 4.19</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.19</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_4_18.html" title="Version 4.18">next</a> |</li>
            <li class="right" ><a href="release_notes_4_20.html" title="Version 4.20">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
