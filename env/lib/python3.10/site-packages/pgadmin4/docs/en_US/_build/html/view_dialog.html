...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>View Dialog &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">View Dialog</a></li> 
      </ul>
    </div>  
  ...
  <section id="view-dialog">
<span id="id1"></span><h1><span class="target" id="index-0"></span>View Dialog<a class="headerlink" href="#view-dialog" title="Link to this heading">¶</a></h1>
...
dialog tabs: <em>General</em>, <em>Definition</em>, <em>Code</em> and <em>Security</em>”. The <em>SQL</em> tab displays
...
security barrier rule, see Rules and Privileges of the PostgreSQL documentation.</p></li>
<li><p>Set the <em>Security Invoker</em> switch to <em>Yes</em> to indicate that the underlying base
relations are to be checked against the privileges of the user of the view rather
than the view owner. This option is available from PostgreSQL 15 onwards.</p></li>
...
<img alt="View dialog code tab" class="align-center" src="_images/view_code.png" />
<p>Use the workspace in the <em>Code</em> tab to write a query to create a view.</p>
...
<p>The example shown demonstrates creating a view named <em>distributor_code</em>.</p>
<ul class="simple">
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="modifying_tables.html" title="Creating or Modifying a Table">next</a> |</li>
            <li class="right" ><a href="user_mapping_dialog.html" title="User Mapping Dialog">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
