...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 6.14 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 6.13" href="release_notes_6_13.html" />
    <link rel="prev" title="Version 6.15" href="release_notes_6_15.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_6_13.html" title="Version 6.13"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 6.14</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-6-14">
<h1>Version 6.14<a class="headerlink" href="#version-6-14" title="Link to this heading">¶</a></h1>
<p>Release date: 2022-09-22</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin 4 v6.13.</p>
...
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/4059">Issue #4059</a> -  Port schema diff to React. (RM #6133)</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/4060">Issue #4060</a> -  Remove Backgrid and Backform. (RM #6134)</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5035">Issue #5035</a> -  Port the remaining components of the ERD Tool to React. (RM #7343)</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5120">Issue #5120</a> -  Updated keyboard shortcut documentation. (RM #7446)</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5260">Issue #5260</a> -  Remove Alertify from pgAdmin completely. (RM #7619)</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5263">Issue #5263</a> -  Port search object dialog to React. (RM #7622)</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5144">Issue #5144</a> -  Ensure that if BigAnimal authentication is aborted, API calls should be stopped. (RM #7472)</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5209">Issue #5209</a> -  Fixed an issue where pgAdmin failed to start due to bin path migration. (RM #7557)</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5230">Issue #5230</a> -  Fixed an issue where backup does not work due to parameter ‘preexec_fn’ no longer being supported. (RM #7580)</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5250">Issue #5250</a> -  Ensure that the browser tree should be refreshed after changing the ownership. (RM #7607)</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5274">Issue #5274</a> -  Fixed the error message displayed when clicking the cloud server for which deployment is in progress. (RM #7636)</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5275">Issue #5275</a> -  Fixed an issue where the wrong SQL displayed in difference if the user create an RLS policy on the table without a column. (RM #7637)</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5282">Issue #5282</a> -  Ensure that the dump servers functionality works from setup.py. (RM #7644)</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5284">Issue #5284</a> -  Ensure that the Import/Export server menu option is visible. (RM #7646)</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5286">Issue #5286</a> -  Fixed API test case for change password in the server mode. (RM #7648)</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5287">Issue #5287</a> -  Fixed an issue with the non-visibility of columns added prior to import/export data. (RM #7649)</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5292">Issue #5292</a> -  Fixed an issue where textarea of the JSON Editor does not resize with dialog. (RM #7656)</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5299">Issue #5299</a> -  Fixed ModuleNotFoundError when running setup.py to load/dump servers. (RM #7663)</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5323">Issue #5323</a> -  Replace the language selection ‘Brazilian’ with ‘Portuguese (Brazilian). (RM #7693)</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5325">Issue #5325</a> -  Fixed an issue where server names with special characters are not displayed correctly in the process tab. (RM #7695)</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5333">Issue #5333</a> -  Fixed an issue where ERD throws an error if variable is added to the column. (RM #7709)</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5342">Issue #5342</a> -  Fixed an error while saving changes to the ERD table.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5343">Issue #5343</a> -  Fixes a redirect vulnerability when the user opens the pgAdmin URL.</div>
</div>
</div></blockquote>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 6.14</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 6.14</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_6_13.html" title="Version 6.13">next</a> |</li>
            <li class="right" ><a href="release_notes_6_15.html" title="Version 6.15">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
