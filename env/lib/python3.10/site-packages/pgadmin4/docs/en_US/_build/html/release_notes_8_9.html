...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 8.9 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 8.8" href="release_notes_8_8.html" />
    <link rel="prev" title="Version 8.10" href="release_notes_8_10.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_8_8.html" title="Version 8.8"
             accesskey="N">next</a> |</li>
        <li class="right" >
          <a href="release_notes_8_10.html" title="Version 8.10"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 8.9</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-8-9">
<h1>Version 8.9<a class="headerlink" href="#version-8-9" title="Link to this heading">¶</a></h1>
<p>Release date: 2024-06-27</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin 4 v8.8.</p>
...
<p><strong>psql</strong>, <strong>pg_dump</strong>, <strong>pg_dumpall</strong>, <strong>pg_restore</strong>: 16.3</p>
</section>
<section id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Link to this heading">¶</a></h2>
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5932">Issue #5932</a> -  Provide option to set theme based on OS theme preference.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7363">Issue #7363</a> -  Remove the usage of MUI makeStyles as it doesn’t support React 18.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6357">Issue #6357</a> -  Disable the query tool editor input if any SQL is being loaded to prevent users from typing.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7241">Issue #7241</a> -  Fixed an issue where resizable data editors in query tool should not be allowed to resize beyond the app window bounds.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7295">Issue #7295</a> -  Fixed new line indentation in query editor and add a user preference to disable it.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7306">Issue #7306</a> -  Ensure that a user can connect to a server using SSL certificates and identity files from a shared storage.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7316">Issue #7316</a> -  Fixed an issue where object explorer toolbar button not showing shortcut in the tooltip.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7414">Issue #7414</a> -  Add support for comments on RLS policy object.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7476">Issue #7476</a> -  Fixed an issue where changing a column name should reflect in all the constraints in table object dialog and ERD table dialog.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7481">Issue #7481</a> -  Fixed an issue where dark theme shows white background when all tabs are closed.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7516">Issue #7516</a> -  Ensure preferences can be loaded using preferences.json.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7523">Issue #7523</a> -  Fixed an issue where the schema diff incorrectly marked tables as different due to schema-qualified trigger functions in the trigger definitions.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7528">Issue #7528</a> -  Fixed an issue where backslash breaks syntax highlighting.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7536">Issue #7536</a> -  Search Objects dialog should focus on search input on open.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7542">Issue #7542</a> -  Fixed incorrect sorting of size in statistics tab.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7555">Issue #7555</a> -  Fixed an issue where query tool shortcuts for find/replace are not working.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7556">Issue #7556</a> -  Fixed migration failure while using external database.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7593">Issue #7593</a> -  Fixed an issue where query tool auto-complete stops working after connection change.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7605">Issue #7605</a> -  Fix the permissions issue in the pgAdmin installation directory on Debian and RHEL-8 platforms (CVE-2024-6238).</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7616">Issue #7616</a> -  Fixed an issue where delete button in Users data was enabled for incorrect rows.</div>
</div>
</div></blockquote>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 8.9</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 8.9</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_8_8.html" title="Version 8.8">next</a> |</li>
            <li class="right" ><a href="release_notes_8_10.html" title="Version 8.10">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
