...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Package Dialog &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">Package Dialog</a></li> 
      </ul>
    </div>  
  ...
  <section id="package-dialog">
<span id="id1"></span><h1><span class="target" id="index-0"></span>Package Dialog<a class="headerlink" href="#package-dialog" title="Link to this heading">¶</a></h1>
...
dialog tabs: <em>General</em>, <em>Header</em>, <em>Body</em>, and <em>Security</em>. The <em>SQL</em> tab displays the SQL
...
<p>Click the <em>Header</em> tab to continue.</p>
<img alt="Package dialog header tab" class="align-center" src="_images/package_header.png" />
<p>Use the <em>Header</em> field to define the public interface for the package.</p>
<p>Click the <em>Body</em> tab to continue.</p>
<img alt="Package dialog body tab" class="align-center" src="_images/package_body.png" />
<p>Use the <em>Body</em> field to provide the code that implements each package object.</p>
...
<p>Use the fields in the <em>Security</em> tab to assign EXECUTE privileges for the
...
two function and two procedure.</p>
<ul class="simple">
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="procedure_dialog.html" title="Procedure Dialog">next</a> |</li>
            <li class="right" ><a href="materialized_view_dialog.html" title="Materialized View Dialog">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
