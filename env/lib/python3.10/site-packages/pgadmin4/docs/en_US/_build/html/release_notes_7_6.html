...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 7.6 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 7.5" href="release_notes_7_5.html" />
    <link rel="prev" title="Version 7.7" href="release_notes_7_7.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_7_5.html" title="Version 7.5"
             accesskey="N">next</a> |</li>
        <li class="right" >
          <a href="release_notes_7_7.html" title="Version 7.7"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 7.6</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-7-6">
<h1>Version 7.6<a class="headerlink" href="#version-7-6" title="Link to this heading">¶</a></h1>
<p>Release date: 2023-08-24</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin 4 v7.5.</p>
...
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/2595">Issue #2595</a> -  Added Expression to CREATE INDEX.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/3942">Issue #3942</a> -  Added cascade option while creating an extension.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5759">Issue #5759</a> -  Added ‘Ignore Grants’ option in the schema diff tool.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6004">Issue #6004</a> -  Added ‘Ignore Tablespace’ option in the schema diff tool.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6375">Issue #6375</a> -  Added support for ALTER INDEX column statistics.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6376">Issue #6376</a> -  Added unlogged option while creating a sequence.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6377">Issue #6377</a> -  Added all like options while creating a table.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6381">Issue #6381</a> -  Added support for SYSTEM, CONCURRENTLY and TABLESPACE options in REINDEX.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6382">Issue #6382</a> -  Added WAL option to EXPLAIN ANALYZE command.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6397">Issue #6397</a> -  Added new/missing options to the VACUUM command.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6415">Issue #6415</a> -  Added SKIP_LOCKED and BUFFER_USAGE_LIMIT option to Analyze command.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6448">Issue #6448</a> -  Add support for TRUNCATE trigger in foreign table.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6595">Issue #6595</a> -  Ensure that Schema Diff comparison results should be displayed in the sorted order.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/3702">Issue #3702</a> -  Generate software bill of materials as part of the package builds.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6588">Issue #6588</a> -  Added support for PostgreSQL and EPAS 16 to ensure it works without any errors.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5454">Issue #5454</a> -  Fix incorrect redirection URL after authentication by removing fixed value set to SCRIPT_NAME environment variable in pgAdmin4.wsgi file.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6208">Issue #6208</a> -  Allow changing the POOL_SIZE and MAX_OVERFLOW config values of the pgAdmin config DB connection pool.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6252">Issue #6252</a> -  Fix an issue where query tool on shared server is throwing error if the pgAdmin config DB is external.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6420">Issue #6420</a> -  Fix the query tool issue where raise Notice from func/proc or code blocks are no longer displayed live.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6500">Issue #6500</a> -  Fix the issue where query tool window turns blank if the user tries to generate a graph on the result.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6624">Issue #6624</a> -  Fix an issue where changing MFA_SUPPORTED_METHODS breaks the MFA validation.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6630">Issue #6630</a> -  Fix an issue where pgAdmin 7.5 fails to render table SQL with extension loaded index method.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6639">Issue #6639</a> -  Fix an issue where cycle syntax was not added in SQL when creating new sequence from UI.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6651">Issue #6651</a> -  Fix an issue where the SET directive is excluded from the function header in the schema diff tool.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6660">Issue #6660</a> -  Fix a query tool error ‘pgAdminThread’ object has no attribute ‘native_id’.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6664">Issue #6664</a> -  Ensure keyboard shortcut for query execution is disabled when query execution is in progress.</div>
</div>
</div></blockquote>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 7.6</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 7.6</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_7_5.html" title="Version 7.5">next</a> |</li>
            <li class="right" ><a href="release_notes_7_7.html" title="Version 7.7">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
