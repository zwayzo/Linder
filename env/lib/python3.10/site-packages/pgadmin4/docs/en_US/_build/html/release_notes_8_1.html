...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 8.1 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 8.0" href="release_notes_8_0.html" />
    <link rel="prev" title="Version 8.2" href="release_notes_8_2.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_8_2.html" title="Version 8.2"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 8.1</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-8-1">
<h1>Version 8.1<a class="headerlink" href="#version-8-1" title="Link to this heading">¶</a></h1>
<p>Release date: 2023-12-14</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin 4 v8.0.</p>
...
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/4580">Issue #4580</a> -  Add support for generating ERD for a schema.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6854">Issue #6854</a> -  Add support for creating a function with custom return type.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6991">Issue #6991</a> -  Fixed several accessibility-related issues for enhanced usability.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5471">Issue #5471</a> -  Ensure focus is not changed to ssh tunnel password input when user explicitly focus on server password input.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6095">Issue #6095</a> -  Provide a way to bypass the SSL cert verification for OAuth2 provider.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6488">Issue #6488</a> -  Fixed an issue where database name was missing in an error message if name contains any special characters.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6717">Issue #6717</a> -  Ensure that indexes created by constraints are visible in the object explorer when “Show system objects” is enabled.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6803">Issue #6803</a> -  Fixed an issue where reading process logs throws an error when DATA_DIR is moved to a networked drive.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6814">Issue #6814</a> -  Remove the ‘Close Window’ submenu specifically for OSX to prevent unintended closure of the entire application.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6842">Issue #6842</a> -  Rename all references of ‘Execute query’ to ‘Execute script’ to be more relevant.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6887">Issue #6887</a> -  Fixed an issue where syntax error was not highlighting in query tool.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6921">Issue #6921</a> -  Fixed an issue where on entering full screen, the option label is not changed to ‘Exit Full Screen’ in desktop mode.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6950">Issue #6950</a> -  Ensure that the Authentication Source in the drop-down of the UserManagement dialog aligns with the entries specified for AUTHENTICATION_SOURCES in the configuration file.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6958">Issue #6958</a> -  Reverse engineer serial columns when generating ERD for database/table.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6964">Issue #6964</a> -  Fixed an issue where the Schema was not visible in the dropdown for table properties or when creating a new table.</div>
...
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6984">Issue #6984</a> -  Fixed an issue where the Vacuum option INDEX_CLEANUP have an incorrect value (‘AUTO’) for database versions &lt; 14.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6989">Issue #6989</a> -  Fixed an issue where the pgAdmin page went blank when clicking the delete button in the User Management dialog.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7000">Issue #7000</a> -  Ensure that correct timezone is set for Docker deployments.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7011">Issue #7011</a> -  Fixed an issue where all rows and filter rows buttons of object explorer toolbar were disabled for views and other supported nodes.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/7017">Issue #7017</a> -  Fixed an issue where schema diff tool is not loading preferences on start.</div>
</div>
</div></blockquote>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 8.1</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 8.1</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_8_0.html" title="Version 8.0">next</a> |</li>
            <li class="right" ><a href="release_notes_8_2.html" title="Version 8.2">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
