...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Server Group Dialog &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">Server Group Dialog</a></li> 
      </ul>
    </div>  
  ...
  <section id="server-group-dialog">
<span id="id1"></span><h1><span class="target" id="index-0"></span>Server Group Dialog<a class="headerlink" href="#server-group-dialog" title="Link to this heading">¶</a></h1>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="server_dialog.html" title="Server Dialog">next</a> |</li>
            <li class="right" ><a href="connecting.html" title="Connecting To A Server">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
