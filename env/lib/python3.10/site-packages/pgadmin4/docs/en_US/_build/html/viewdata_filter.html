...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>View/Edit Data Filter &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Schema Diff" href="schema_diff.html" />
    ...
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-0"><a href="index.html">pgAdmin 4 9.11 documentation</a> &#187;</li>
          ...
          <li class="nav-item nav-item-2"><a href="editgrid.html" accesskey="U">View/Edit Data</a> &#187;</li>
        <li class="nav-item nav-item-this"><a href="">View/Edit Data Filter</a></li> 
      </ul>
    </div>  
  ...
  <section id="view-edit-data-filter">
<span id="viewdata-filter"></span><h1><span class="target" id="index-0"></span>View/Edit Data Filter<a class="headerlink" href="#view-edit-data-filter" title="Link to this heading">¶</a></h1>
<p>You can access <em>Data Filter dialog</em> by clicking on <em>Filtered Rows</em> toolbar button
visible on the Browser panel or by selecting <em>View/Edit Data -&gt; Filtered Rows</em>
context menu option.</p>
<p>This allows you to specify an SQL Filter to limit the data displayed
in the edit grid window:</p>
<img alt="View Data filter dialog window" class="align-center" src="_images/viewdata_filter_dialog.png" />
</section>
...
<li class="toctree-l2 current"><a class="reference internal" href="editgrid.html">View/Edit Data</a></li>
...
<span>«</span>
    ...
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-0"><a href="index.html">pgAdmin 4 9.11 documentation</a> &#187;</li>
          <li class="nav-item nav-item-1"><a href="developer_tools.html" >Developer Tools</a> &#187;</li>
          <li class="nav-item nav-item-2"><a href="editgrid.html" >View/Edit Data</a> &#187;</li>
        <li class="nav-item nav-item-this"><a href="">View/Edit Data Filter</a></li> 
      </ul>
    </div>
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="schema_diff.html" title="Schema Diff">next</a> |</li>
            <li class="right" ><a href="editgrid.html" title="View/Edit Data">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
