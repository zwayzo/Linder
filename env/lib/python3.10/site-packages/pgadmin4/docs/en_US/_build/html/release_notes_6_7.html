...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 6.7 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 6.6" href="release_notes_6_6.html" />
    <link rel="prev" title="Version 6.8" href="release_notes_6_8.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">Version 6.7</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-6-7">
<h1>Version 6.7<a class="headerlink" href="#version-6-7" title="Link to this heading">¶</a></h1>
<p>Release date: 2022-03-14</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin4 6.6.</p>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p><strong>Security Release</strong></p>
<p>Please note that this release includes a security update to fix an issue
where a user could upload files to directories outside of their storage directory, when using pgAdmin
running in server mode.</p>
<p>Users running pgAdmin in server mode, including the standard container based distribution, should upgrade
to this release as soon as possible.</p>
<p>This issue does not affect users running in desktop mode.</p>
</div>
<section id="bug-fixes">
<h2>Bug fixes<a class="headerlink" href="#bug-fixes" title="Link to this heading">¶</a></h2>
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7220">Issue #7220</a> -  Fixed a schema diff issue where difference SQL isn’t generated when foreign key values for a table differ.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7228">Issue #7228</a> -  Fixed a schema diff issue where string separator ‘_$PGADMIN$_’ is visible for identical user mappings.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7230">Issue #7230</a> -  Fixed an issue where pgAdmin 4 took ~75 seconds to display the ‘Starting pgAdmin’ text on the splash screen.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7233">Issue #7233</a> -  Ensure that upload paths are children of the storage directory (CVE-2022-0959).</div>
</div>
</div></blockquote>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 6.7</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 6.7</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_6_6.html" title="Version 6.6">next</a> |</li>
            <li class="right" ><a href="release_notes_6_8.html" title="Version 6.8">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
