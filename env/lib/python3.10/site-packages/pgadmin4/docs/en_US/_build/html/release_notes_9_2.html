...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 9.2 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 9.1" href="release_notes_9_1.html" />
    <link rel="prev" title="Version 9.3" href="release_notes_9_3.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_9_3.html" title="Version 9.3"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 9.2</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-9-2">
<h1>Version 9.2<a class="headerlink" href="#version-9-2" title="Link to this heading">¶</a></h1>
<p>Release date: 2025-04-03</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin 4 v9.1.</p>
...
<p><strong>psql</strong>, <strong>pg_dump</strong>, <strong>pg_dumpall</strong>, <strong>pg_restore</strong>: 17.2</p>
</section>
<section id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Link to this heading">¶</a></h2>
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/0392">Issue #0392</a> -  Added an ability to configure the font family for SQL editors.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/4194">Issue #4194</a> -  Added support to automatically open a file after it is downloaded in the desktop mode.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/4503">Issue #4503</a> -  Added support for post-connection SQL execution, which will be run automatically on each connection made to any database of the server.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5871">Issue #5871</a> -  Add support for restoring plain SQL database dumps.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8034">Issue #8034</a> -  Added support for creating Directory nodes in EPAS.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8449">Issue #8449</a> -  Change icon buttons to show tooltip even when disabled.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8540">Issue #8540</a> -  Add an option to load/replace the servers.json file on each container startup.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8574">Issue #8574</a> -  Open user management in a separate tab instead of a dialog to enhance UI/UX.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8545">Issue #8545</a> -  Added Security.md file.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8316">Issue #8316</a> -  Ensure that modal dialogs are not triggered more than once to avoid duplicates.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8355">Issue #8355</a> -  Change session files garbage collection strategy.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8362">Issue #8362</a> -  Fixed an issue where pgAdmin should fallback to main screen if the last opened screen is disconnected.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8437">Issue #8437</a> -  Fixed an issue where the PSQL terminal displays keyname for non alphanumeric keys.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8462">Issue #8462</a> -  Fixed an issue where geometries in the geometry viewer will render partially when the container was resized.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8473">Issue #8473</a> -  Change the stop/terminate icon at all the places for better UX.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8479">Issue #8479</a> -  Fixed an issue where the Schema Diff was not displaying the difference query when a table had a UNIQUE NULLS NOT DISTINCT constraint.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8483">Issue #8483</a> -  Fixed an issue where the query tool data grid did not respect the default value for columns of domain type when the domain had a default value.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8514">Issue #8514</a> -  Ensure the newly added parameters in the server dialog are incorporated into the Import/Export Servers functionality.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8546">Issue #8546</a> -  Fixed an issue where updating the grantee was not correctly applying the privileges.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8577">Issue #8577</a> -  Fixed an issue where the upgrade_check API returned an unexpected keyword argument ‘cafile’ due to changes in the urllib package supporting Python v3.13.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8597">Issue #8597</a> -  Fixed an issue where delete/rename was done on wrong file after sorting in Storage Manager.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8602">Issue #8602</a> -  Fixed an XSS vulnerability issue in the Query Tool and View/Edit Data (CVE-2025-2946).</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8603">Issue #8603</a> -  Fixed a remote code execution issue in the Query Tool and Cloud Deployment (CVE-2025-2945).</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/8623">Issue #8623</a> -  Fixed an issue where query tool is crashing on macOS 15.4 due to a locale issue.</div>
</div>
</div></blockquote>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 9.2</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 9.2</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_9_1.html" title="Version 9.1">next</a> |</li>
            <li class="right" ><a href="release_notes_9_3.html" title="Version 9.3">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
