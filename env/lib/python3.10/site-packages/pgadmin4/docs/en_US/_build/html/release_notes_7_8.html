...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 7.8 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 7.7" href="release_notes_7_7.html" />
    <link rel="prev" title="Version 8.0" href="release_notes_8_0.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_8_0.html" title="Version 8.0"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 7.8</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-7-8">
<h1>Version 7.8<a class="headerlink" href="#version-7-8" title="Link to this heading">¶</a></h1>
<p>Release date: 2023-10-19</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin 4 v7.7.</p>
...
<p><strong>EDB Advanced Server</strong>: 12, 13, 14 and 15</p>
</section>
...
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/640">Issue #640</a> -    Add support for foreign table’s new functionality for PG 11 and above.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6229">Issue #6229</a> -  Allow setting custom username for shared servers, with default as username of server being shared.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6373">Issue #6373</a> -  Add ‘GENERATED ALWAYS AS..’ option while creating column constraints for Foreign Table.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6797">Issue #6797</a> -  GUI representation of the system’s activity using the ‘system_stats’ extension.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6802">Issue #6802</a> -  Added ‘load_balance_hosts’ connection string parameter for PG 16 and above.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6782">Issue #6782</a> -  Use PG16 as the default PostgreSQL version.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/4995">Issue #4995</a> -  Fixed an issue in ERD tool where the downloaded images have a few links cut.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5749">Issue #5749</a> -  Fixed an issue where user was not able to assign new/old columns as primary key once column with primary key is deleted.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6285">Issue #6285</a> -  Add support for setting prepare threshold in server connection.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6482">Issue #6482</a> -  Fixed an issue where the wrong message “Current database has been moved or renamed” is displayed when debugging any function.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6538">Issue #6538</a> -  Fixed an issue where Processes tab displays wrong server name in some scenario.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6579">Issue #6579</a> -  Fix an issue where global/native keyboard shortcuts are not working when any cell of data output grid has focus.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6666">Issue #6666</a> -  Fixed query history slowness issue by storing query only for those having certain threshold max length.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6674">Issue #6674</a> -  Fix an issue where foreign table column name becomes “none” if the user changes any column data type.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6718">Issue #6718</a> -  Pin the cryptography version to fix PyO3 modules initialisation error.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6790">Issue #6790</a> -  Ensure that the backup works properly for PG 16 on the latest docker image.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6799">Issue #6799</a> -  Fixed an issue where the user is unable to select objects on the backup dialog due to tree flickering.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6836">Issue #6836</a> -  Fixed an issue where non-super PostgreSQL users are not able to terminate their own connections from dashboard.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6851">Issue #6851</a> -  Fix an issue where scale in columns is not allowed to have value as 0 or below.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6858">Issue #6858</a> -  Fix an issue in graphical explain plan where query tool crashes when the plan has parallel workers details and sort node is clicked for details.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6865">Issue #6865</a> -  Fix an issue where user login is not working if username/email contains single quote in server mode.</div>
</div>
</div></blockquote>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 7.8</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 7.8</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_7_7.html" title="Version 7.7">next</a> |</li>
            <li class="right" ><a href="release_notes_8_0.html" title="Version 8.0">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
