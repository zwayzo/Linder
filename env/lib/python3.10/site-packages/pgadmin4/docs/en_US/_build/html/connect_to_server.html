...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Connect to Server &#8212; pgAdmin 4 9.11 documentation</title>
...
<img alt="Connect to server dialog" class="align-center" src="_images/connect_to_server.png" />
...
<img alt="Connect to server dialog" class="align-center" src="_images/connect_to_tunneled_server.png" />
<p>Provide authentication information for the selected server:</p>
<blockquote>
<div><ul class="simple">
<li><p>Use the <em>Password</em> field to provide the password of the user that is
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="connect_error.html" title="Connection Error">next</a> |</li>
            <li class="right" ><a href="master_password.html" title="Master Password">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
