...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 6.11 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 6.10" href="release_notes_6_10.html" />
    <link rel="prev" title="Version 6.12" href="release_notes_6_12.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">Version 6.11</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-6-11">
<h1>Version 6.11<a class="headerlink" href="#version-6-11" title="Link to this heading">¶</a></h1>
<p>Release date: 2022-06-30</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin 4 v6.10.</p>
<section id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Link to this heading">¶</a></h2>
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/2647">Issue #2647</a> -  Added mouse over indication for breakpoint area in the Debugger.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/2648">Issue #2648</a> -  Added search text option to the Debugger panel.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7178">Issue #7178</a> -  Added capability to deploy PostgreSQL servers on Microsoft Azure.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7332">Issue #7332</a> -  Added support for passing password using Docker Secret to Docker images.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7351">Issue #7351</a> -  Added the option ‘Show template databases?’ to display template databases regardless of the setting of ‘Show system objects?’.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7485">Issue #7485</a> -  Added support for visualise the graph using a Line chart in the query tool.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/6132">Issue #6132</a> -  Port Debugger to React.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7315">Issue #7315</a> -  Updates documentation for the Traefik v2 container deployment.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7411">Issue #7411</a> -  Update pgcli to latest release 3.4.1.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7469">Issue #7469</a> -  Upgrade Chartjs to the latest 3.8.0.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7423">Issue #7423</a> -  Fixed an issue where there is no setting to turn off notifications in the Query Tool.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7440">Issue #7440</a> -  Fixed an issue where passwords entered in the ‘Connect To Server’ dialog were truncated.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7441">Issue #7441</a> -  Ensure that the Query Editor should be focused when switching between query tool tabs.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7443">Issue #7443</a> -  Fixed and issue where ‘Use spaces’ not working in the query tool.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7453">Issue #7453</a> -  Fixed an issue where the Database restriction is not working.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7460">Issue #7460</a> -  Fixed an issue where pgAdmin stuck while creating a new index.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7461">Issue #7461</a> -  Fixed an issue where the connection wasn’t being closed when the user switched to a new connection and closed the query tool.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7468">Issue #7468</a> -  Skip the history records if the JSON info can’t be parsed instead of showing ‘No history’.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7502">Issue #7502</a> -  Fixed an issue where an error message is displayed when creating the new database.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/7506">Issue #7506</a> -  Fixed permission denied error when deploying PostgreSQL in Azure using Docker.</div>
</div>
</div></blockquote>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 6.11</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 6.11</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_6_10.html" title="Version 6.10">next</a> |</li>
            <li class="right" ><a href="release_notes_6_12.html" title="Version 6.12">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
