...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Synonym Dialog &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="prev" title="Subscription Dialog" href="subscription_dialog.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">Synonym Dialog</a></li> 
      </ul>
    </div>  
  ...
  <section id="synonym-dialog">
<span id="id1"></span><h1><span class="target" id="index-0"></span>Synonym Dialog<a class="headerlink" href="#synonym-dialog" title="Link to this heading">¶</a></h1>
...
<img alt="Synonym dialog general tab" class="align-center" src="_images/synonym_definition.png" />
<ul class="simple">
<li><p>Use the drop-down listbox next to <em>Target Type</em> to select the type of
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="trigger_function_dialog.html" title="Trigger Function Dialog">next</a> |</li>
            <li class="right" ><a href="subscription_dialog.html" title="Subscription Dialog">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
