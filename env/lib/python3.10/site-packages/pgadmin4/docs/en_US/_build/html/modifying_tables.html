...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Creating or Modifying a Table &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">Creating or Modifying a Table</a></li> 
      </ul>
    </div>  
  ...
  <section id="creating-or-modifying-a-table">
<span id="modifying-tables"></span><h1><span class="target" id="index-0"></span>Creating or Modifying a Table<a class="headerlink" href="#creating-or-modifying-a-table" title="Link to this heading">¶</a></h1>
...
that object.  For example, to create a new table, Select a database from the tree control, select the schema under the database, right-click on the <em>Tables</em>
node, and select <em>Create Table…</em></p>
...
<li class="toctree-l1"><a class="reference internal" href="compound_trigger_dialog.html">Compound Trigger Dialog</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="rls_policy_dialog.html">RLS Policy Dialog</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="check_dialog.html" title="Check Dialog">next</a> |</li>
            <li class="right" ><a href="view_dialog.html" title="View Dialog">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
