...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Collation Dialog &#8212; pgAdmin 4 9.11 documentation</title>
...
this tab.</p></li>
<li><p>Use the drop-down listbox next to <em>Provider</em> to select a locale services associated
with the collation. Possible values are: icu, libc and builtin.
<strong>Note:</strong> The builtin option is available from v17 onwards.</p></li>
...
<li><p>Use the <em>Rules</em> field to specify rules for customizing the behavior of the collation.
...
<p>Your entries in the <em>Collation</em> dialog generate a SQL command (see an example
...
rules specified for the locale, <em>fr-BI-x-icu</em>.  The collation is owned by
<em>postgres</em>.</p>
<ul>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="domain_dialog.html" title="Domain Dialog">next</a> |</li>
            <li class="right" ><a href="dbms_schedule.html" title="DBMS Schedule">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
