...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>External database for pgAdmin user settings &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="connecting.html" title="Connecting To A Server">next</a> |</li>
            <li class="right" ><a href="search_objects.html" title="Search objects">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
