...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>PGD Replication Server Node Dialog &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Role Reassign/Drop Own Dialog" href="role_reassign_dialog.html" />
    <link rel="prev" title="PGD Replication Group Node Dialog" href="pgd_replication_group_dialog.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="role_reassign_dialog.html" title="Role Reassign/Drop Own Dialog"
             accesskey="N">next</a> |</li>
        <li class="right" >
          <a href="pgd_replication_group_dialog.html" title="PGD Replication Group Node Dialog"
        ...
        <li class="nav-item nav-item-0"><a href="index.html">pgAdmin 4 9.11 documentation</a> &#187;</li>
          ...
          <li class="nav-item nav-item-2"><a href="pgd_replication_group_dialog.html" accesskey="U">PGD Replication Group Node Dialog</a> &#187;</li>
        <li class="nav-item nav-item-this"><a href="">PGD Replication Server Node Dialog</a></li> 
      </ul>
    </div>  
  ...
  <section id="pgd-replication-server-node-dialog">
<span id="pgd-replication-server-dialog"></span><h1><span class="target" id="index-0"></span>PGD Replication Server Node Dialog<a class="headerlink" href="#pgd-replication-server-node-dialog" title="Link to this heading">¶</a></h1>
<p>Use The <em>Replication Server Node</em> dialog to view an element that run
databases and participate in the PGD cluster. A typical PGD node runs a Postgres
database, the BDR extension, and optionally a PGD Proxy service.</p>
<p>The dialog organizes the information through the following tabs:
<em>General</em></p>
<img alt="Replication Server Node Dialog general tab" class="align-center" src="_images/pgd_server_node_dialog.png" />
<ul class="simple">
<li><p>The <em>Sequence ID</em> field is the identifier of the node used for generating unique sequence numbers.</p></li>
<li><p>The <em>ID</em> field is the OID of the node.</p></li>
<li><p>The <em>Name</em> field is the name of the node.</p></li>
<li><p>The <em>Kind</em> field is the node kind name.</p></li>
<li><p>The <em>Group Name</em> field is the PGD group the node is part of.</p></li>
<li><p>The <em>Local DB Name</em> field is the database name of the node.</p></li>
</ul>
<p>Other buttons:</p>
<ul class="simple">
...
<li class="toctree-l2 current"><a class="reference internal" href="pgd_replication_group_dialog.html">PGD Replication Group Node Dialog</a></li>
...
<span>«</span>
    ...
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-0"><a href="index.html">pgAdmin 4 9.11 documentation</a> &#187;</li>
          <li class="nav-item nav-item-1"><a href="managing_cluster_objects.html" >Managing Cluster Objects</a> &#187;</li>
          <li class="nav-item nav-item-2"><a href="pgd_replication_group_dialog.html" >PGD Replication Group Node Dialog</a> &#187;</li>
        <li class="nav-item nav-item-this"><a href="">PGD Replication Server Node Dialog</a></li> 
      </ul>
    </div>
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="role_reassign_dialog.html" title="Role Reassign/Drop Own Dialog">next</a> |</li>
            <li class="right" ><a href="pgd_replication_group_dialog.html" title="PGD Replication Group Node Dialog">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
