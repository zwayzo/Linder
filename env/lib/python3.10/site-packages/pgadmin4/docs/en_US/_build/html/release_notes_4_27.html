...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 4.27 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 4.26" href="release_notes_4_26.html" />
    <link rel="prev" title="Version 4.28" href="release_notes_4_28.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_4_28.html" title="Version 4.28"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 4.27</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-4-27">
<h1>Version 4.27<a class="headerlink" href="#version-4-27" title="Link to this heading">¶</a></h1>
<p>Release date: 2020-10-15</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin4 4.26.</p>
<section id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/1402">Issue #1402</a> -  Added Macro support.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/2519">Issue #2519</a> -  Added support to view trigger function under the respective trigger node.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3794">Issue #3794</a> -  Allow user to change the database connection from an open query tool tab.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5200">Issue #5200</a> -  Added support to ignore the owner while comparing objects in the Schema Diff tool.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5857">Issue #5857</a> -  Added documentation for Macro support.</div>
</div>
</section>
<section id="housekeeping">
<h2>Housekeeping<a class="headerlink" href="#housekeeping" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5330">Issue #5330</a> -  Improve code coverage and API test cases for Functions.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5395">Issue #5395</a> -  Added RESQL/MSQL test cases for Functions.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5497">Issue #5497</a> -  Merged the latest code of ‘pgcli’ used for the autocomplete feature.</div>
</div>
</section>
<section id="bug-fixes">
<h2>Bug fixes<a class="headerlink" href="#bug-fixes" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4806">Issue #4806</a> -  Added useful message when the explain plan is not used and empty.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4855">Issue #4855</a> -  Fixed an issue where file extension is stripped on renaming a file.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5131">Issue #5131</a> -  Ensure that ‘ctrl + a’ shortcut does not move the cursor in SQL editor.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5417">Issue #5417</a> -  Fixed and improve API test cases for the schema diff tool.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5739">Issue #5739</a> -  Ensure that the import/export feature should work with SSH Tunnel.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5802">Issue #5802</a> -  Remove maximum length on the password field in the server dialog.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5807">Issue #5807</a> -  Fixed an issue where a column is renamed and then removed, then the drop SQL query takes the wrong column name.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5826">Issue #5826</a> -  Fixed an issue where schema diff is showing identical table as different due to default vacuum settings.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5830">Issue #5830</a> -  Fixed reverse engineering SQL where parenthesis is not properly arranged for View/MView definition.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5835">Issue #5835</a> -  Fixed ‘can’t execute an empty query’ message if the user change the option of Auto FK Index.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5839">Issue #5839</a> -  Ensure that multiple extensions can be dropped from the properties tab.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5841">Issue #5841</a> -  Fixed an issue where the server is not able to connect using the service.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5843">Issue #5843</a> -  Fixed an issue where the ‘PARALLEL UNSAFE’ option is missing from reverse engineering SQL of function/procedure.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5845">Issue #5845</a> -  Fixed an issue where the query tool is not fetching more than 1000 rows for the table does not have any primary key.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5853">Issue #5853</a> -  Fixed an issue where ‘Rows X’ column values were not visible properly for Explain Analyze in Dark theme.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5855">Issue #5855</a> -  Ensure that the user should be able to change the start value of the existing sequence.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5861">Issue #5861</a> -  Ensure that the ‘Remove Server’ option should be visible in the context menu.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5867">Issue #5867</a> -  Fixed an issue where some properties are not being updated correctly for the shared server.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5882">Issue #5882</a> -  Fixed invalid literal issue when fetching dependencies for Materialized View.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/5885">Issue #5885</a> -  Fixed an issue where the user is unable to change the macro name.</div>
</div>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 4.27</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.27</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_4_26.html" title="Version 4.26">next</a> |</li>
            <li class="right" ><a href="release_notes_4_28.html" title="Version 4.28">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
