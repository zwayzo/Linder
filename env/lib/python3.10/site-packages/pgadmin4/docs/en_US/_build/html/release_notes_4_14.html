...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 4.14 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 4.13" href="release_notes_4_13.html" />
    <link rel="prev" title="Version 4.15" href="release_notes_4_15.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">Version 4.14</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-4-14">
<h1>Version 4.14<a class="headerlink" href="#version-4-14" title="Link to this heading">¶</a></h1>
<p>Release date: 2019-10-17</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin4 4.13.</p>
<section id="new-features">
<h2>New features<a class="headerlink" href="#new-features" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3009">Issue #3009</a> -  Added Copy with headers functionality when copy data from Query Tool/View Data.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4778">Issue #4778</a> -  Implemented the Query Plan Analyser.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4823">Issue #4823</a> -  Include PostgreSQL 12 binaries in the container.</div>
</div>
</section>
<section id="housekeeping">
<h2>Housekeeping<a class="headerlink" href="#housekeeping" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4472">Issue #4472</a> -  Add Reverse Engineered and Modified SQL tests for Synonyms.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4628">Issue #4628</a> -  Add Reverse Engineered and Modified SQL tests for Unique Constraints.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4701">Issue #4701</a> -  Optimize Webpack to improve overall performance.</div>
</div>
</section>
<section id="bug-fixes">
<h2>Bug fixes<a class="headerlink" href="#bug-fixes" title="Link to this heading">¶</a></h2>
<div class="line-block">
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/3386">Issue #3386</a> -  Ensure backup a partition table should not backup the whole database.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4199">Issue #4199</a> -  Ensure that ‘ENTER’ key in the data filter should not run the query.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4590">Issue #4590</a> -  Fix issue where backup fails for schema name that needs quoting.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4728">Issue #4728</a> -  Highlighted the color of closing or opening parenthesis when user select them in CodeMirror.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4751">Issue #4751</a> -  Fix issue where export job fails when deselecting all the columns.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4753">Issue #4753</a> -  Fix an error where ‘false’ string is displayed when we add a new parameter in the Parameters tab, also clear the old value when the user changes the parameter name.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4755">Issue #4755</a> -  Ensure that pgAdmin should work behind reverse proxy if the inbuilt server is used as it is.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4756">Issue #4756</a> -  Fix issue where pgAdmin does not load completely if loaded in an iframe.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4760">Issue #4760</a> -  Ensure the search path should not be quoted for Database.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4768">Issue #4768</a> -  Ensure pgAdmin should work behind reverse proxy on a non standard port.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4769">Issue #4769</a> -  Fix query tool open issue on Internet Explorer.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4777">Issue #4777</a> -  Fix issue where query history is not visible in the query history tab.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4780">Issue #4780</a> -  Ensure the search path should not be quoted for Function, Procedure and Trigger Function.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4791">Issue #4791</a> -  Fix issue where VALID foreign keys show as NOT VALID in the SQL tab for tables.</div>
<div class="line"><a class="reference external" href="https://redmine.postgresql.org/issues/4817">Issue #4817</a> -  Ensure the MAC OSX app should be notarized for Catalina.</div>
</div>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 4.14</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 4.14</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_4_13.html" title="Version 4.13">next</a> |</li>
            <li class="right" ><a href="release_notes_4_15.html" title="Version 4.15">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
