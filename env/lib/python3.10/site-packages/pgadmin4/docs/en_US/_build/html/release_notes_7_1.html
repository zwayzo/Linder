...
<html lang="en" data-content_root="./">
  <head>
    ...
    <title>Version 7.1 &#8212; pgAdmin 4 9.11 documentation</title>
    ...
    <link rel="next" title="Version 7.0" href="release_notes_7_0.html" />
    <link rel="prev" title="Version 7.2" href="release_notes_7_2.html" /> 
  </head><body>
    <div class="related" role="navigation" aria-label="Related">
      ...
      <ul>
        ...
        <li class="right" >
          <a href="release_notes_7_0.html" title="Version 7.0"
             accesskey="N">next</a> |</li>
        <li class="right" >
          <a href="release_notes_7_2.html" title="Version 7.2"
        ...
        <li class="nav-item nav-item-this"><a href="">Version 7.1</a></li> 
      </ul>
    </div>  
  ...
  <section id="version-7-1">
<h1>Version 7.1<a class="headerlink" href="#version-7-1" title="Link to this heading">¶</a></h1>
<p>Release date: 2023-05-04</p>
<p>This release contains a number of bug fixes and new features since the release of pgAdmin 4 v7.0.</p>
...
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/2078">Issue #2078</a> -  Show object breadcrumbs path along with its comment on object hover.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/3275">Issue #3275</a> -  Allow on demand record count setting to be changed per user using preferences.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/3316">Issue #3316</a> -  Added support to show statistics for materialized views.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/3318">Issue #3318</a> -  Added support to create an unnamed index.</div>
</div>
</div></blockquote>
</section>
...
<blockquote>
<div><div class="line-block">
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5044">Issue #5044</a> -  Fixed an issue where query tool hangs for some time when multiple columns are selected to open geometry viewer.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5777">Issue #5777</a> -  Fixed an issue where the browser tree state is not remembered when reopening pgAdmin.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5820">Issue #5820</a> -  Fixed an issue where collation was set to none if we remove it while creating partitioned table.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/5922">Issue #5922</a> -  Ensure that when pasting a row in query tool grid, default value is used for autogenerated/serial columns.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6059">Issue #6059</a> -  Show proper message if the debugger is stopped by the user.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6075">Issue #6075</a> -  Ensure that the save button is enabled when registering a new server fails due to an API error.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6077">Issue #6077</a> -  The search object, query tool, and psql tool menu should not be displayed for pgAgent.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6120">Issue #6120</a> -  Fixed error occurring while logging out from pgAdmin keeping a query tool opened.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6128">Issue #6128</a> -  Fix a SQL error occurring on roles dependents SQL.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6130">Issue #6130</a> -  Ensure to quote the primary key value if needed while deleting rows from the table.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6137">Issue #6137</a> -  Fixed error occurring while dumping the servers from CLI.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6138">Issue #6138</a> -  Throw an appropriate error when a table for which View/Edit data is open, is deleted, and query is executed.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6151">Issue #6151</a> -  Ensure that internal users are able to login when auth sources are [ldap, internal].</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6158">Issue #6158</a> -  Fixed an issue with the properties tab not getting updated if the user updates the selected node.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6159">Issue #6159</a> -  Ensure that the ERD tool should work with the external database after moving to psycopg3.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6180">Issue #6180</a> -  Fixed an issue where PSQL is not working if the PGUSER env variable is set and service file is used for server connection details.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6183">Issue #6183</a> -  Mac crash when you press Command-Shift-C.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6189">Issue #6189</a> -  Fix an issue in View SQL when column level privileges are set with multiple roles.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6191">Issue #6191</a> -  Fixed an issue where Reset Password is not working after upgrading to latest flask-security-too.</div>
<div class="line"><a class="reference external" href="https://github.com/pgadmin-org/pgadmin4/issues/6234">Issue #6234</a> -  Usernames/roles with special character are not double quoted when assigning privileges.</div>
</div>
</div></blockquote>
</section>
</section>
  ...
  <div>
    ...
    <ul>
<li><a class="reference internal" href="#">Version 7.1</a><ul>
...
<li class="toctree-l2 current"><a class="current reference internal" href="#">Version 7.1</a></li>
    ...
    <div class="footer" role="contentinfo">
        <div class="related" role="navigation" aria-label="related navigation">
          <ul>
            ...
            <li class="right" ><a href="release_notes_7_0.html" title="Version 7.0">next</a> |</li>
            <li class="right" ><a href="release_notes_7_2.html" title="Version 7.2">previous</a> |</li>
          </ul>
        </div>
    </div>
  </body>
